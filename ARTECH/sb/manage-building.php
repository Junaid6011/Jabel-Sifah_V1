                    ...
                    <div class="panel panel-default card round shadow  ">
                        ...
                        <div class="panel-body padding-15">
                            <div class="form-group margin-bottom-10">
                                <a href="" class="btn btn-success btn-block bg-blue-800 bg-theme btn-round" data-toggle="modal" data-target="#add-asset"> <i class="ri-add-circle-fill"></i> New Building</a>
                            </div>
                                                            ...
                                                            <div class="col-lg-12">
                                                                <div class="col-lg-6">
                                                                    <div class="form-group margin-bottom-10">
                                                                        ...
                                                                        <input type="text" class="form-control" value="" placeholder="Enter Building Name">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="form-group margin-bottom-10">
                                                                        <label> Address</label>
                                                                        <input type="text" class="form-control" value="" placeholder="Enter Address">
                                                                    </div>
                                                                </div>
                            ...
                            <div class="form-group margin-bottom-10">
                                <fieldset class="form-fieldset">
                                    ...
                                    <div class="form-group margin-bottom-10">
										...
										<a tabindex="0" class="" data-tokens="null" role="option" aria-disabled="false" aria-selected="false"><span class="text">Building 2</span>
                                    ...
                                    <div class="form-group margin-bottom-0 text-center">
                                        <a href="" class="btn btn-success bg-blue-800 btn-round btn-block1"> <i class=" ri-search-line "></i> Search</a>
                        ...
                        <div class="panel panel-default card round shadow  ">
                            ...
                            <div class="panel-body padding-15">
                                ...
                                <div class="table-responsive   vscroll" style="height: auto;">
                                    <div id="ppp_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer" style="width: 100%;"><div class="row"><div class="col-sm-12 col-md-6"></div><div class="col-sm-12 col-md-6"></div></div><div class="row"><div class="col-sm-12"><div class="dataTables_scroll"><div class="dataTables_scrollHead" style="overflow: hidden; position: relative; border: 0px; width: 100%;"><div class="dataTables_scrollHeadInner" style="box-sizing: content-box; width: 972px; padding-right: 3px;"><table class="table nowrap margin-bottom-0 table-bordered  table-striped theme-table1  bg-white  table-condensed  text-wrap dataTable no-footer" role="grid" style="margin-left: 0px; width: 972px;"><thead>
                                            <tr role="row"><th class="sorting_asc" tabindex="0" aria-controls="ppp" rowspan="1" colspan="1" style="width: 59px;" aria-sort="ascending" aria-label=" Id : activate to sort column descending"> Id </th>
											<th class="sorting" tabindex="0" aria-controls="ppp" rowspan="1" colspan="1" style="width: 389px;" aria-label=" Building Name: activate to sort column ascending"> Building Name</th><th class="sorting" tabindex="0" aria-controls="ppp" rowspan="1" colspan="1" style="width: 360px;" aria-label=" Location: activate to sort column ascending"> Location</th><th class="sorting" tabindex="0" aria-controls="ppp" rowspan="1" colspan="1" style="width: 163px;" aria-label=" Action: activate to sort column ascending"> Action</th></tr>
                                            ...
                                            <tr role="row" style="height: 0px;"><th class="sorting_asc" aria-controls="ppp" rowspan="1" colspan="1" style="width: 59px; padding-top: 0px; padding-bottom: 0px; border-top-width: 0px; border-bottom-width: 0px; height: 0px;" aria-sort="ascending" aria-label=" Id : activate to sort column descending"><div class="dataTables_sizing" style="height: 0px; overflow: hidden;"> Id </div></th><th class="sorting" aria-controls="ppp" rowspan="1" colspan="1" style="width: 389px; padding-top: 0px; padding-bottom: 0px; border-top-width: 0px; border-bottom-width: 0px; height: 0px;" aria-label=" Building Name: activate to sort column ascending"><div class="dataTables_sizing" style="height: 0px; overflow: hidden;"> Building Name</div></th><th class="sorting" aria-controls="ppp" rowspan="1" colspan="1" style="width: 360px; padding-top: 0px; padding-bottom: 0px; border-top-width: 0px; border-bottom-width: 0px; height: 0px;" aria-label=" Location: activate to sort column ascending"><div class="dataTables_sizing" style="height: 0px; overflow: hidden;"> Location</div></th><th class="sorting" aria-controls="ppp" rowspan="1" colspan="1" style="width: 163px; padding-top: 0px; padding-bottom: 0px; border-top-width: 0px; border-bottom-width: 0px; height: 0px;" aria-label=" Action: activate to sort column ascending"><div class="dataTables_sizing" style="height: 0px; overflow: hidden;"> Action</div></th></tr>
                                        ...
                                        <tr role="row" class="odd">
                                                ...
                                                <td class="sorting_1 dtr-control"> 11 </td>
                                                <td>
                                                    <div class="media" style="max-width: 130px;">
                                                        <div class="media-left padding-right-10">
                                                            <img src="images/building.jpg" class="img-bordered" style="height:30px">
