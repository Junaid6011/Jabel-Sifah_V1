 ...
 <div class="page ">
        ...
        <div class="breadcrumb-box">
            <ol class="breadcrumb breadcrumb-arrow ">
                <li><a href="javascript:void(0)"> building/detail </a> </li>
...
<div class=" page-content Container-fluid">
            ...
            <div class="row card-group-row  ">
                ...
                <div class="col-lg-12  card-group-row__col ">
                    <div class="panel panel-default  round shadow  " style="width:1300px">
                        <div class="panel-heading margin-bottom-0 ">
                            <h3 class="panel-title font-weight-600 bg-teal-8001 white1 ">Building Details</h3>
                                ...
                                <div class="col-md-12">
                                    <div class="margin-bottom-25">
                                        ...
                                        <div class="form-group margin-bottom-10 text-center">
                                            <img src="images/building.jpg" style="height: 150px;">
                                        </div>
