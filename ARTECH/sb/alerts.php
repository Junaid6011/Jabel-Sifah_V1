...
<div class="page-header page-header-bordered  bg-grey-200 shadow1">
                <div class="font-size-20 font-weight-500 margin-bottom-0 ">Alerts
                    <!-- <div class="inline-block font-size-16 margin-left-15">
                        <select class="form-control selectpicker form-control" data-style="btn-select" data-width="auto">
                        <option data-icon="x">Floor 1</option>
                    </select></div> -->
                </div>
                <div class="page-header-actions" style="z-index:20;">
                    <div class="dropdown dropdown-menu-right inline-block">
                        <a class="btn btn-primary dropdown-toggle btn-sm" data-toggle="dropdown" href="#">
                            <i class="ri-download-line"></i> Export
                        </a>
                        <ul class="dropdown-menu dropdown-menu-right ">
                            <li>
                                <a href="detail-meter.php"><i class="icon ion-android-person"></i> PDF </a>
                            </li>

                            <li>
                                <a href="detail-meter.php"><i class="icon ion-android-settings"></i>CSV</a>
                            </li>
                        </ul>
                    </div>
                    <a href="" class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="bottom" data-original-title="Refresh"><i class="ri-refresh-fill"></i></a>
                </div>
            ...
            <div class=" page-content container-fluid">
                ...
                <!-- <div class="font-size-18 font-weight-500 margin-bottom-10">Building Overview</div> -->
                        ...
                        <div class="panel panel-default  round shadow  ">
                            ...
                            <div class="panel-body padding-15">
                                ...
                                <div class="form-group margin-bottom-10">
                                    <a href="" class="btn btn-success btn-block bg-theme btn-round" data-toggle="modal"
                                        data-target="#add-new"> <i class="ri-add-circle-fill"></i> New </a>
                                </div> -->
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group margin-bottom-10">
                                                            ...
                                                            <input type="text" class="form-control" value="" placeholder="Serial No">
                                                        </div>
                                                    </div>
    ...
    color: inherit;
    border: 0;
    border-bottom: 1px solid transparent;">Filter</legend>
                                        <div class="form-group margin-bottom-5">
                                            <div class="btn-group bootstrap-select form-control"><button type="button" class="btn dropdown-toggle bs-placeholder btn-select" data-toggle="dropdown" role="button" title="Category">
											<span class="filter-option pull-left">Category</span>&nbsp;<span class="bs-caret"><span class="caret"></span></span></button><div class="dropdown-menu open" role="combobox"><ul class="dropdown-menu inner" role="listbox" aria-expanded="false"><li data-original-index="1"><a tabindex="0" class="" data-tokens="null" role="option" aria-disabled="false" aria-selected="false">
											<span class="text">Battery Level</span>
											<span class="glyphicon glyphicon-ok check-mark"></span></a></li><li data-original-index="2">
											
											<a tabindex="0" class="" data-tokens="null" role="option" aria-disabled="false" aria-selected="false">
											<span class="text">Over Consumption</span>
                                        ...
                                        <fieldset class="form-fieldset">
                                            ...
                                            <div class="form-group margin-bottom-0 text-center">
                                                <a href="" class="btn btn-success bg-blue-800 btn-round btn-sm"> <i class=" ri-search-line "></i> Search</a>
                                                <a href=" " class="btn btn-default btn-round btn-sm"> <i class="ri-refresh-line "></i>
                                                    Clear
                                                </a>
                                            </div>
                        ...
                        <div class="width-full">
                            ...
                            <div class="panel panel-default round shadow  ">
                                ...
                                <div class="panel-body padding-10">
                                    ...
                                    <table class="table nowrap margin-bottom-0 table-bordered1   table-condensed ">
                                        <tbody>
                                            <tr class="font-size-10 font-weight-500 bg-grey-100">
                                                <th>Sr </th>
                                            ...
                                            <tr>
                                                ...
                                                <td> 4 </td>
												<td> Device#4</td>
                                                <td>Critical Battery Level </td>
                                                <td> 24/04/2021 19:00 </td>
                                            </tr>
                                            <tr>
                                                <td> 2 </td>
