 ...
 <div class="page ">
        ...
        <div class="breadcrumb-box">
            <ol class="breadcrumb breadcrumb-arrow ">
                <li><a href="javascript:void(0)"> Water Consumption Reports </a> </li>
            ...
            <div class="row card-group-row  ">
                    ...
                    <div class="panel panel-default card round shadow  ">
                        ...
                        <div class="panel-body padding-15">
                            ...
                            <div class="form-group margin-bottom-10">
                                <div class="btn-group bootstrap-select form-control"><button type="button" class="btn dropdown-toggle bs-placeholder btn-select" data-toggle="dropdown" role="button" title="Choose Building"><span class="filter-option pull-left">Choose Building</span>&nbsp;<span class="bs-caret">
								<span class="caret"></span></span></button><div class="dropdown-menu open" role="combobox">
								<ul class="dropdown-menu inner" role="listbox"><li data-original-index="1"><a tabindex="0" class="" data-tokens="null" role="option" aria-disabled="false" aria-selected="false">
								<span class="text">Building1</span><span class="glyphicon glyphicon-ok check-mark"></span></a></li>
								<li data-original-index="2"><a tabindex="0" class="" data-tokens="null" role="option" aria-disabled="false" aria-selected="false"><span class="text">Building2 </span>
								<span class="glyphicon glyphicon-ok check-mark"></span></a></li><li data-original-index="3">
								<a tabindex="0" class="" data-tokens="null" role="option" aria-disabled="false" aria-selected="false">
								<span class="text">Building3 </span><span class="glyphicon glyphicon-ok check-mark"></span></a></li>
								<li data-original-index="4"><a tabindex="0" class="" data-tokens="null" role="option" aria-disabled="false" aria-selected="false">
								<span class="text">Building4 </span><span class="glyphicon glyphicon-ok check-mark"></span></a></li></ul></div>
                            ...
                            <div class="form-group margin-bottom-10">
								...
								<a tabindex="0" class="" data-tokens="null" role="option" aria-disabled="false" aria-selected="false">
								<span class="text"> Floor1</span><span class="glyphicon glyphicon-ok check-mark"></span></a></li><li data-original-index="2">
								<a tabindex="0" class="" data-tokens="null" role="option" aria-disabled="false" aria-selected="false"><span class="text"> Floor2 </span>
								<span class="glyphicon glyphicon-ok check-mark"></span></a></li><li data-original-index="3">
								<a tabindex="0" class="" data-tokens="null" role="option" aria-disabled="false" aria-selected="false">
								<span class="text"> Floor3 </span><span class="glyphicon glyphicon-ok check-mark"></span></a></li>
								<li data-original-index="4"><a tabindex="0" class="" data-tokens="null" role="option" aria-disabled="false" aria-selected="false">
								<span class="text"> Floor4 </span><span class="glyphicon glyphicon-ok check-mark"></span></a></li></ul></div>
                            ...
                            <div class="form-group margin-bottom-10">
                                <div class="btn-group bootstrap-select form-control">
								<button type="button" class="btn dropdown-toggle bs-placeholder btn-select" data-toggle="dropdown" role="button" title="Choose Apartment/Office">
								<span class="filter-option pull-left">Choose Apartment/Office</span>&nbsp;<span class="bs-caret"><span class="caret"></span></span></button>
								...
								<span class="text"> Apartment/Office1</span><span class="glyphicon glyphicon-ok check-mark"></span></a></li>
								<li data-original-index="2"><a tabindex="0" class="" data-tokens="null" role="option" aria-disabled="false" aria-selected="false">
								<span class="text"> Apartment/Office2 </span><span class="glyphicon glyphicon-ok check-mark"></span></a></li>
								<li data-original-index="3"><a tabindex="0" class="" data-tokens="null" role="option" aria-disabled="false" aria-selected="false">
								<span class="text"> Apartment/Office3 </span><span class="glyphicon glyphicon-ok check-mark"></span></a></li><li data-original-index="4">
								<a tabindex="0" class="" data-tokens="null" role="option" aria-disabled="false" aria-selected="false">
								<span class="text"> Apartment/Office4 </span>
								<span class="glyphicon glyphicon-ok check-mark"></span></a></li></ul></div>
								</div>
                            </div>
                            <div class="form-group margin-bottom-10">
                                <div class="btn-group bootstrap-select form-control"><button type="button" class="btn dropdown-toggle bs-placeholder btn-select" data-toggle="dropdown" role="button" title="Choose Device">
								<span class="filter-option pull-left">Choose Device</span>&nbsp;<span class="bs-caret">
								<span class="caret"></span></span></button><div class="dropdown-menu open" role="combobox">
								<ul class="dropdown-menu inner" role="listbox"><li data-original-index="1">
								<a tabindex="0" class="" data-tokens="null" role="option" aria-disabled="false" aria-selected="false">
								<span class="text">Device#1</span><span class="glyphicon glyphicon-ok check-mark"></span></a></li>
								<li data-original-index="2"><a tabindex="0" class="" data-tokens="null" role="option" aria-disabled="false" aria-selected="false">
								<span class="text">Device#2</span><span class="glyphicon glyphicon-ok check-mark"></span></a></li><li data-original-index="3">
								<a tabindex="0" class="" data-tokens="null" role="option" aria-disabled="false" aria-selected="false"><span class="text">Device#3 </span>
                            ...
                            <div class="form-group margin-bottom-10">
                                <fieldset class="form-fieldset">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="radio-custom checkbox-inline1 radio-warning">
                                                    <input type="radio" id="444" name="radio">
                                                    <label for="444">Current Day</label>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <div class="radio-custom checkbox-inline1 radio-warning">
                                                    <input type="radio" id="555" name="radio">
                                                    <label for="555">Previous Week </label>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <div class="radio-custom checkbox-inline1 radio-warning">
                                                    <input type="radio" id="666" name="radio">
                                                    <label for="666">Previous Month </label>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <div class="radio-custom checkbox-inline1 radio-warning">
                                                    <input type="radio" id="666r" name="radio" checked="">
                                    ...
                                    <div class="form-group margin-bottom-0">
                                        <input type="date" class="form-control" value="3">
                                    </div>
                            ...
                            <div class="form-group margin-bottom-10">
                                <a href="" class="btn btn-success btn-block bg-theme btn-round">Show Report</a>
                            </div>
                            <hr>
                            <div class="form-group margin-bottom-0">
                ...
                <div class="col-lg-8  card-group-row__col ">
                    <div class="width-full">
                        ...
                        <div class="panel panel-default card round shadow  ">
                            <div class="panel-heading margin-bottom-0">
                                <h3 class="panel-title font-weight-600 bg-theme1 white1 "> Report
                            ...
                            <div class="panel-body padding-15">
                                <div class="form-group margin-bottom-10">
                                    <div class="input-search" style="max-width:30%">
                                ...
                                <div class="table-responsive   vscroll" style="height: auto;">
                                    <div id="ppp_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer" style="width: 100%;"><div class="row"><div class="col-sm-12 col-md-6"></div><div class="col-sm-12 col-md-6"></div></div><div class="row"><div class="col-sm-12"><table class="table nowrap margin-bottom-0 table-bordered  table-striped theme-table1  bg-white  table-condensed  text-wrap dataTable no-footer dtr-inline" id="ppp" role="grid" aria-describedby="ppp_info" style="width: 951px;">
                                        <thead>
											...
											<th class="sorting_asc" tabindex="0" aria-controls="ppp" rowspan="1" colspan="1" style="width: 144px;" 
											aria-sort="ascending" aria-label="Device Name: activate to sort column descending">Device Name</th>
											<th class="sorting" tabindex="0" aria-controls="ppp" rowspan="1" colspan="1" style="width: 200px;" 
											aria-label=" Building : activate to sort column ascending"> Building </th>
											<th class="sorting" tabindex="0" aria-controls="ppp" rowspan="1" colspan="1"
											style="width: 58px;" aria-label=" Floor : activate to sort column ascending"> Floor </th>
											<th class="sorting" tabindex="0" aria-controls="ppp" rowspan="1" colspan="1" style="width: 165px;
											" aria-label=" Apartment/Office: activate to sort column ascending"> Apartment/Office</th>
											<th class="sorting" tabindex="0" aria-controls="ppp" rowspan="1" colspan="1" style="width: 114px;
											" aria-label=" Room : activate to sort column ascending"> Average Water Temperature </th>
											<th class="sorting" tabindex="0" aria-controls="ppp" rowspan="1" colspan="1" style="width: 198px;
											" aria-label="Average Consumption: activate to sort column ascending">Average Consumption</th>
											<th class="sorting" tabindex="0" aria-controls="ppp" rowspan="1" colspan="1" style="width: 114px;
											" aria-label=" Room : activate to sort column ascending"> Average Flow Rate </th>
											<th class="sorting" tabindex="0" aria-controls="ppp" rowspan="1" colspan="1" style="width: 114px;
											" aria-label=" Room : activate to sort column ascending"> Battery Level </th>
                                        ...
                                        <tr role="row" class="odd">
                                                ...
                                                <div class="media" style="max-width: 130px;">
                                                        ...
                                                        <div class="media-body">
                                                            <a href="building-details.php" class="font-weight-600">HN HQ</a>
                                                ...
                                                <td style="">400 Liters </td>
                                                <td style="">10 Lit/min </td>
                                                <td style="">10 Volt </td>
									...
									<div class="row">
									<div class="col-sm-12 col-md-5"><div class="dataTables_info" id="ppp_info" role="status" aria-live="polite">Showing 1 to 4 of 4 entries
									</div></div><div class="col-sm-12 col-md-7">
									<div class="dataTables_paginate paging_simple_numbers" id="ppp_paginate"><ul class="pagination">
									<li class="paginate_button page-item previous disabled" id="ppp_previous">
									<a href="#" aria-controls="ppp" data-dt-idx="0" tabindex="0" class="page-link">Previous</a></li>
									<li class="paginate_button page-item active"><a href="#" aria-controls="ppp" data-dt-idx="1" tabindex="0" class="page-link">1</a></li>
									<li class="paginate_button page-item next disabled" id="ppp_next"><a href="#" aria-controls="ppp" data-dt-idx="2" tabindex="0" class="page-link">Next
