 ...
 <div class="page ">
        ...
        <div class="breadcrumb-box">
            ...
            <div class=" page-content container-fluid">
                ...
                <!-- <div class="font-size-18 font-weight-500 margin-bottom-10">Floor Overview</div> -->
                        ...
                        <div class="panel panel-default  round shadow  ">
                            ...
                            <div class="panel-body padding-15">
                                ...
                                <div class="form-group margin-bottom-10">
                                    <a href="" class="btn btn-success btn-block bg-blue-800 bg-theme btn-round" data-toggle="modal" data-target="#add-new"> <i class="ri-add-circle-fill"></i> New </a>
                                </div>
                                    ...
                                    <div class="modal-dialog modal-lg1">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title"> Assign Meter </h4>
                                            </div>
                                        ...
                                        <input type="text" class="form-control" placeholder="..." />
                                                    ...
                                                    <div class="input-icon">
                                                        <select class="form-control selectpicker " data-width="100%" data-size="5" data-style="btn-select">
                                                            <option data-subtext=""> JS HQ </option>
                                                            <option data-subtext=""> AR HQ </option>
                                                            <option data-subtext=""> HS HQ </option>
                                                            <option data-subtext=""> JS HQ_2 </option>
                                                        </select>
                                                    </div>
                                                    </div>
</div>
                                                    ...
                                                    <div class="input-icon">
                                                        <select class="form-control selectpicker " data-width="100%" data-size="5" data-style="btn-select">
                                                            <option data-subtext=""> Floor-1 </option>
                                                            <option data-subtext=""> Floor-4 </option>
                                                            <option data-subtext=""> Floor-5 </option>
                                                            <option data-subtext=""> Floor-6 </option>
                                                        </select>
                                                    </div>
                                                        </div>
                                                    </div>
<div class="col-lg-6">
                                                    ...
                                                    <div class="input-icon">
                                                        <select class="form-control selectpicker " data-width="100%" data-size="5" data-style="btn-select">
                                                            <option data-subtext=""> WM-002 </option>
                                                            <option data-subtext=""> WM-004 </option>
                                                            <option data-subtext=""> WM-009 </option>
                                                            <option data-subtext=""> Wm-006 </option>
                                                        </select>
                                                    </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <table class="table nowrap margin-bottom-0 table-bordered1   table-condensed ">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="detail-meter.php"> 34121273</a></td>
                                                <td> Xvg Meter </td>
                                                <td> Building4 </td>
                                                <td> Floor-1273</td>
                                                
                                               
                                                <td> Melburg Street no-02, North Area</td>
                                                <td> ON</td>
                                                <!-- <td>


                                                    <a type="button" href="#add-new"
                                                        class="btn btn-icon  btn-info btn-xs " data-toggle="modal"
                                                        data-target="#add-new"> <i class="ri-pencil-fill"></i> </a>
