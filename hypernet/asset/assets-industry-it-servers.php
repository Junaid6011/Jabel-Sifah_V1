                                    ...
                                    <div class="white">
                                        ...
                                        <div class="">
                                            <div class=" margin-right-15 inline">
                                                <i> <img src="images/server.png" alt="img" height="40"> </i>
                                            </div>
                                            <b class="font-size-24" style="position:relative; top:5px;">300</b>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                                        ...
                                                                        <div class="inline-block margin-right-20 ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox" id="qqqy"
                                                                                    name="" />
                                                                                <label for="qqqy">N-way server</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    <li class="list-group-item padding-0 ">
                                                                        ...
                                                                        <div class="inline-block margin-right-20 ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox" id="111n"
                                                                                    name="" />
                                                                                <label for="111n">RISC server</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    <li class="list-group-item padding-0 ">
                                                                        <div class="inline-block margin-right-20 ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox" id="222n"
                                                                                    name="" />
                                                                                <label for="222n"> Tower server</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    <li class="list-group-item padding-0 ">
                                                                        ...
                                                                        <div class="inline-block margin-right-20 ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox" id="qqqw"
                                                                                    checked />
                                                                                <label for="qqqw">N-way server</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    <li class="list-group-item padding-0 ">
                                                                        ...
                                                                        <div class="inline-block margin-right-20 ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox" id="111e"
                                                                                    checked />
                                                                                <label for="111e">RISC server</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    <li class="list-group-item padding-0 ">
                                                                        <div class="inline-block margin-right-20 ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox" id="222e"
                                                                                    checked />
                                                                                <label for="222e"> Blade server</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    <li class="list-group-item padding-0 ">
                                                                        ...
                                                                        <div class="inline-block ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox" id="Compactor"
                                                                                    value="ARM- based server">
                                                                                <label for="Compactor">ARM- based
                                                                                    server</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                        ...
                                                                        <div class="inline-block ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox" id="Chain"
                                                                                    value="Rack server">
                                                                                <label for="Chain">Rack server</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    ...
                                                                    <li class="list-group-item">
                                                                        ...
                                                                        <div class="inline-block ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox"
                                                                                    id="Scalable server"
                                                                                    value="Scalable server">
                                                                                <label for="Scalable server">Scalable
                                                                                    server</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="assets-industry-it-server.php"
                                                                                class="font-weight-600">Nutanix HCI
                                                                            </a>
                                                                            <br />
                                                                            <i class="small"> Blade server</i>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <div class=" font-weight-600">Cryptowaretech
                                                                            </div>
                                                                ...
                                                                <td class="text-center hidden">Blade server </td>
                                                                <td class="text-center">
                                                                    <button type="button"
                                                            ...
                                                            <tr>
                                                                <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="assets-industry-it-server.php"
                                                                                class="font-weight-600">Fusion-XR30
                                                                            </a>
                                                                            <br />
                                                                            <i class="small">ARM- based server</i>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <td class="text-center hidden">ARM- based server </td>
                                                                <td class="text-left">
                                                                ...
                                                                <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <div class=" font-weight-600">Nexus</div>
                                                            ...
                                                            <tr>
                                                                <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="assets-industry-it-server.php"
                                                                                class="font-weight-600">Hana-VS29
                                                                            </a>
                                                                            <br />
                                                                            <i class="small"> Rack server</i>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <div class=" font-weight-600"> Nova
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <td class="text-center"> March
                                                                    ...
                                                                    09:07:08
                                                                    pm</td>
                                                                <td class="text-center hidden">Rack server </td>
                                                                <td class="text-center">
                                                                    <button type="button"
                                                                        class="btn btn-icon  btn-default btn-xs collapsed"
                                                                        data-toggle="collapse" data-target="#info100"><i
                                                                            class="icon ion-plus"></i>
                                                                    </button>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="assets-industry-it-server.php"
                                                                                class="font-weight-600">Azure-WV19
                                                                            </a>
                                                                            <br />
                                                                            <i class="small">N-way server</i>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <div class=" font-weight-600">Cybill
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <td class="text-center"> April
                                                                    ...
                                                                    09:07:08
                                                                    pm</td>
                                                                <td class="text-center hidden">N-way server </td>
                                                                <td class="text-center">
                                                                    <button type="button"
                                                                        class="btn btn-icon  btn-default btn-xs collapsed"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <div class=" font-weight-600"> InTouch
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <div class=" font-weight-600"> Nerdware
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <div class=" font-weight-600">Apex
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <tr>
                                                                <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="assets-industry-it-server.php"
                                                                                class="font-weight-600"> Azurr-WV19
                                                                            </a>
                                                                            <br />
                                                                            <i class="small">RISC server</i>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <div class=" font-weight-600">Morter
                                                                            </div>
                                                                ...
                                                                <td class="text-center"> Feb
                                                                    ...
                                                                    10:07:08
                                                                    pm</td>
                                                                <td class="text-center hidden">RISC server </td>
                                                                <td class="text-center">
                                                                    <button type="button"
                                                                        class="btn btn-icon  btn-default btn-xs collapsed"
                                                            ...
                                                            <tr>
                                                                <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            ...
                                                                            <br />
                                                                            <i class="small">Scalable server</i>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <td class="text-center"> Jan
                                                                    ...
                                                                    11:07:08
                                                                    pm</td>
                                                                <td class="text-center hidden">Scalable server </td>
                                                                <td class="text-center">
                                                                    <button type="button"
                                                                        class="btn btn-icon  btn-default btn-xs collapsed"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <div class=" font-weight-600"> Iron Clad
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <td class="text-center">
                                                                    <button type="button"
                                                                        class="btn btn-icon  btn-default btn-xs collapsed"
                                                                        data-toggle="collapse" data-target="#info17"><i
                                                                            class="icon ion-plus"></i>
                                                                    </button>
                                                                </td>
                                                            </tr>
