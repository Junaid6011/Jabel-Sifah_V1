                ...
                <div class="text-center" style="width:700px; margin:auto;">
                    <div class="input-group">
                        ...
                        <div class="
                            ...
                            <button type=" button" class="btn btn-info padding-left-20 padding-right-10 dropdown-toggle "
                        ...
                        <input type="text" id="query" class="form-control btn-round " style="height:36px;" placeholder="Enter Tracking Number..."
                            name="query" required="" value="478">
                        <span class="input-group-btn">
                            <button type="submit" onclick="window.location.href='" class="btn btn-warning  padding-left-20 padding-right-20 "
                                id=""><span class="glyphicon glyphicon-search"></span> Track</button>
                        </span>
                            ...
                            <table class="table  margin-bottom-0 table-hover table-condensed1 bg-white table-bordered      "
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-left">
                                            <div class="media" style="max-width: 200px;">
                                                <div class="media-left padding-right-10">
                                                    <img src="images/icon-bulldozer-photo.jpg" class="img-bordered" style="height:36px">
                                                </div>
                                                <div class="media-body">
                                                    <a href="assets-industry-construction-bulldozer.php" class="font-weight-600">BULLDOZER  
                                                    </a>
                                                    <br>
                                        ...
                                        <td class="text-left"> Bulldozer </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-left">
                                            <div class="media" style="max-width: 200px;">
                                                <div class="media-left padding-right-10">
                                                    <img src="images/icon-medical-machine3.jpg" class="img-bordered"
                                                        style="height:36px">
                                                </div>
                                                <div class="media-body">
