        ...
        <div class="page-content  container-fluid">
            ...
            <div class="media margin-bottom-30 bg-white padding-30 margin-top-0  card shadow light">
                <div class="media-left">
                    <img src="images/server-photo.png" alt="img" style="height:170px;" class="img-bordered ">
                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="media">
                                                            <div class="media-left">
                                                                <figure class="">
                                                                    <img src="images/server-photo.png"
                                                                        class="img-bordered" style="height: 50px">
                                                                </figure>
                                                            </div>
                                                            <div class="media-body">
                                                                ...
                                                                <div class="font-size-12  "> Assigned Server</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
