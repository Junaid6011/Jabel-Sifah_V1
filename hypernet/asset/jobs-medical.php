        ...
        <div class="page-content  container-fluid">
            ...
            <div class="row">
                    ...
                    <div class="widget  white margin-bottom-30 shadow card light">
                        <div class="padding-30 bg-white ">
                            <div class="text-center padding-top-0">
                                <div class="">
                                    <div class=" font-size-24 margin-bottom-10 margin-top-0">Overall Jobs Statistics
                                    </div>
                                    <!-- <div class="dropdown margin-bottom-10 ">
                                        <button type="button" class="btn bg-teal-500 btn-block white dropdown-toggle btn-xs"
                                    ...
                                    <ul
                                        ...
                                        <li>
                                            <h5 class="font-size-12 margin-bottom-0">
                                                Completed
                ...
                <div class="col-lg-8  ">
                    ...
                    <div class="panel panel-default shadow card  light ">
                        ...
                        <div class="panel-body ">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class=" font-size-24 margin-bottom-10 margin-top-0 text-center">Task Completion
                                        Statistics</div>
                                            ...
                                            $(document).ready(function ($) {
                                                (function () {
                                                    var simple_line_chart = c3.generate({
                                                        ...
                                                        data: {
                                                            columns: [
                                                                ['Tasks', 830, 420, 550, 540, 660, 750],
                                                                ['Completed', 300, 200, 160, 400, 250, 250],
                                                                ['Pending', 200, 130, 90, 240, 130, 220],
                                                                ['Inprogess', 130, 120, 150, 140, 160, 150],
                                                                ['Failed', 90, 70, 20, 50, 60, 120],
                                                            ],
                                                            type: 'bar',
                                                            types: {
                                                                Tasks: 'line',
                                                            ...
                                                            groups: [
                                                                ['Completed', 'Pending', 'Inprogess', 'Failed']
                                                            ]
                                                        },
                                                        color: {
                                        ...
                                        <div class="row no-space1">
                                            <div class="col-md-3">
                                                <div class="widget shadow card margin-0">
                                                    <div
                                                        class="  bg-blue-700 vertical-align height-100 white  text-center relative ">
                                            ...
                                            <div class="col-md-3">
                                                <div class="widget shadow card margin-0">
                                                    <div
                                                        class="  bg-red-700 vertical-align height-100 white  text-center relative ">
                                                        <div class="vertical-align-middle">
                                                            <div class="margin-bottom-0 ">
                                            ...
                                            <div class="col-md-3">
                                                <div class="widget shadow card margin-0">
                                                    <div
                                                        class="  bg-green-700 vertical-align height-100 white  text-center relative ">
                                                        <div class="vertical-align-middle">
                                                            <div class="margin-bottom-0 ">
                                            ...
                                            <div class="col-md-3">
                                                <div class="widget shadow card margin-0">
                                                    <div
                                                        class="  bg-teal-700 vertical-align height-100 white  text-center relative ">
                                                        <div class="vertical-align-middle">
                                                            <div class="margin-bottom-0 ">
                    ...
                    <div class="panel panel-default  padding-0  card shadow light" style="min-height: 200px;">
                        <div class="panel-heading font-weight-600 margin-bottom-0">
                            <ul class="nav nav-tabs nav-tabs-line" data-plugin="nav-tabs" role="tablist">
                                ...
                                <li class=""><a data-toggle="tab" href="#Failed">Failed </a></li>
                                <li class=""><a data-toggle="tab" href="#Inprogress">Inprogress </a></li>
                                <li class=""><a data-toggle="tab" href="#Unassigned">Unassigned </a></li>
                            </ul>
                        </div>
                                            ...
                                            <div class="table-responsive">
                                                <table
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td class="text-left"> <a href="job.php">JOB163</a> </td>
                                                            <td class="text-left">
                                                                <div class="media" style="max-width: 200px;">
                                                                    <div class="media-left padding-right-10">
                                                                        <img src="images/icon-truck-photo2.png"
                                                            ...
                                                            <td class="text-left"> 25-June-2019, 11:10am</td>
                                                            <td class="text-left">26-June-2019, 02:40am </td>
                                                            <td class="text-left">Reference sem Ipsum, giving
                                                                information on its originite
                                                                about Lorem Ipsum, giving
                                                                information on its origins, as well
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-left"> 12-July-2019, 09:10am</td>
                                                            <td class="text-left">13-July-2019, 03:40am </td>
                                                            <td class="text-left">Reference sem Ipsum, giving
                                                                information on its originite
                                                                about Lorem Ipsum, giving
                                                                information on its origins, as well
                                                        ...
                                                        <tr>
                                                            <td class="text-left"> <a href="job.php">JOB145</a> </td>
                                                            <td class="text-left">
                                                                <div class="media" style="max-width: 200px;">
                                                                    <div class="media-left padding-right-10">
                                                                        <img src="images/icon-truck-photo.png"
                                                            ...
                                                            <td class="text-left"> 11-Feb-2019, 03:10am</td>
                                                            <td class="text-left">12-Feb-2019, 04:40am </td>
                                                            <td class="text-left">Reference sem Ipsum, giving
                                                                information on its originite
                                                                about Lorem Ipsum, giving
                                                                information on its origins, as well
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-left"> 12-June-2019, 11:10am</td>
                                                            <td class="text-left">13-June-2019, 02:40am </td>
                                                            <td class="text-left">Reference sem Ipsum, giving
                                                                information on its originite
                                                                about Lorem Ipsum, giving
                                                                information on its origins, as well
                                                        ...
                                                        <tr>
                                                            <td class="text-left"> <a href="job.php">JOB136</a> </td>
                                                            <td class="text-left">
                                                                <div class="media" style="max-width: 200px;">
                                                                    <div class="media-left padding-right-10">
                                                                        <img src="images/icon-truck-photo2.png"
                                                            ...
                                                            <td class="text-left"> 25-August-2019, 06:10am</td>
                                                            <td class="text-left">26-August-2019, 01:20am </td>
                                                            <td class="text-left">Reference sem Ipsum, giving
                                                                information on its originite
                                                                about Lorem Ipsum, giving
                                                                information on its origins, as well
                                                        ...
                                                        <tr>
                                                            <td class="text-left"> <a href="job.php">JOB1102/a> </td>
                                                            <td class="text-left">
                                                                <div class="media" style="max-width: 200px;">
                                                                    <div class="media-left padding-right-10">
                                                                        <img src="images/icon-truck-photo1.png"
                                                            ...
                                                            <td class="text-left"> 15-Feb-2019, 11:10am</td>
                                                            <td class="text-left">16-Feb-2019, 02:40am </td>
                                                            <td class="text-left">Reference sem Ipsum, giving
                                                                information on its originite
                                                                about Lorem Ipsum, giving
                                                                information on its origins, as well
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-left"> 25-May-2019, 01:20am</td>
                                                            <td class="text-left">26-June-2019, 07:46am </td>
                                                            <td class="text-left">Reference sem Ipsum, giving
                                                                information on its originite
                                                                about Lorem Ipsum, giving
                                                                information on its origins, as well
                                            ...
                                            <div class="table-responsive">
                                                <table
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-left">
                                                                <div class="media" style="max-width: 200px;">
                                                                    ...
                                                                    <div class="media-body">
                                                                        <a href="fleet.php" class="font-weight-600">UAY
                                                                        </a>
                                                                        <br />
                                                                        <i class="small">Compactor</i>
                                                                    </div>
                                                        ...
                                                        <tr>
                                                            <td class="text-left"> <a href="job.php">JOB129</a> </td>
                                                            <td class="text-left">
                                                                <div class="media" style="max-width: 200px;">
                                                                    <div class="media-left padding-right-10">
                                                                        <img src="images/icon-truck-photo3.png"
                                                            ...
                                                            <td class="text-left"> 15-July-2019, 08:00am</td>
                                                            <td class="text-left">16-July-2019, 10:00am </td>
                                                            <td class="text-left">Reference site
                                                                about Lorem Ipsum, giving
                                                                information on its origins, as well
                                                                as a random Lipsum gem Ipsum, giving
                                                        ...
                                                        <tr>
                                                            <td class="text-left"> <a href="job.php">JOB111</a> </td>
                                                            <td class="text-left">
                                                                <div class="media" style="max-width: 200px;">
                                                                    <div class="media-left padding-right-10">
                                                                        <img src="images/icon-truck-photo2.png"
                                                            ...
                                                            <td class="text-left"> 15-June-2019, 11:02am</td>
                                                            <td class="text-left">16-June-2019, 12:01am </td>
                                                            <td class="text-left">Reference site
                                                                about Lorem Ipsum, giving
                                                                information on its origins, as well
                                                                as a random Lipsum gem Ipsum, giving
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-left"> 12-Feb-2019, 09:02am</td>
                                                            <td class="text-left">13-Feb-2019, 11:01am </td>
                                                            <td class="text-left">Reference site
                                                                about Lorem Ipsum, giving
                                                                information on its origins, as well
                                                                as a random Lipsum gem Ipsum, giving
                                                        ...
                                                        <tr>
                                                            <td class="text-left"> <a href="job.php">JOB116</a> </td>
                                                            <td class="text-left">
                                                                <div class="media" style="max-width: 200px;">
                                                                    <div class="media-left padding-right-10">
                                                                        <img src="images/icon-truck-photo.png"
                                                            ...
                                                            <td class="text-left"> 15-July-2019, 01:02am</td>
                                                            <td class="text-left">16-July-2019, 03:01am </td>
                                                            <td class="text-left">Reference site
                                                                about Lorem Ipsum, giving
                                                                information on its origins, as well
                                                                as a random Lipsum gem Ipsum, giving
