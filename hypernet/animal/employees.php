                                            ...
                                            <div class="widget margin-0 ">
                                                <div class=" padding-10 bg-green-700 height-90 text-center relative">
                                                    <div class="white">
                                                        ...
                                                        <div class="label white  bg-green-600 absolute1  left right bottom">
                                                           60 Online
                                                        </div>
                                                    </div>
                                                </div>
                                                                    ...
                                                                    <li class="list-group-item">
                                                                     ...
                                                                     <li class="list-group-item">
                                                                        ...
                                                                        <div class="inline-block ">
                                                                            <div
                                                                                class="checkbox-custom checkbox-info margin-0 ">
                                                                                <input type="checkbox" id="Caretaker"
                                                                                    value="Caretaker">
                                                                                <label for="Caretaker">Caretaker
                                                                                </label>
                                                                            </div>
                                                                        </div>
                                                                        </li>
                                                ...
                                                <table class="table  table-bordered table-condensed1 table-striped1 margin-bottom-0"id="table">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="text-center hidden">Managers</td>
                                                            <td class="text-center">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center hidden">Caretaker</td>
                                                            <td class="text-center">
                                                                <a href="employee.php" class="btn btn-icon  btn-default btn-xs">
                                                                    View Profile
                                                                </a>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-left">07</td>
                                                             <td class="text-center hidden">Staff</td>
                                                            <td class="text-center">
                                                                <a href="employee.php" class="btn btn-icon  btn-default btn-xs">
                                                                    View Profile
                                                                </a>
