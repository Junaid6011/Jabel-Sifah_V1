...
<body class="layout-boxed admin-bg ">
    ...
    <div class="page1 bg-white">
        <div class="page-header">
            <h1 class="page-title">Territories</h1>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-icon">
                                            <select class="form-control selectpicker " data-width="100%" data-size="5"
                                                ...
                                                <option data-subtext=""> Parking </option>
                                                <option data-subtext=""> Pickup </option>
                                                <option data-subtext=""> Dropoff </option>
                                                <option data-subtext=""> Prohibited </option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
