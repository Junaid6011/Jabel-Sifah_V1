                                            ...
                                            $("#mrq-dd-class2").on('change', function () {
                                                ...
                                                if (this.value.trim().toLowerCase().includes('10')) {
                                                    ...
                                                    simple_line_chart.load({
                                                        unload: true,
                                                        columns:[
                                                                 ['Title 2', 220, 230, 240, 242, 250, 252, 260, 250, 252, 160],
                                                            ],
                                                    });
                                                }
                                            });
                                            ...
                                            $("#mrq-dd-class3").on('change', function () {
                                                ...
                                                if (this.value.trim().toLowerCase().includes('10')) {
                                                    ...
                                                    simple_line_chart1.load({
                                                        unload: true,
                                                        columns:[
                                                                 ['Title1', 280, 270, 265, 272, 274, 270, 273, 242, 260, 255],
                                                                 ['Title2', 220, 215, 210, 205, 212, 210, 213, 212, 210, 243],
                                                                                ...
                                                                                <table class="table  table-condensed  no-border  margin-bottom-0 ">
                                                                                    <thead>
                                                                                        <tr class="">
                                                                                            ...
                                                                                            <th class="text-left">Milk Yield </th>
                                                                                        </tr>
                                                                                    </thead>
                                                                                    <tbody>
                                                                                        <tr>
                                        ...
                                        <div class="table-responsive ">
                                            <table class="table  margin-bottom-0 table-hover table-condensed table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><a href="herd.php">HR-255</a></td>
                                                        <td>Cowbays </td>
                                                    ...
                                                    <tr>
                                                        <td><a href="herd.php">HR-225</a></td>
                                                        <td>Cowthas </td>
                                                    ...
                                                    <tr>
                                                        <td><a href="herd.php">HR-302</a></td>
                                                        <td>Cowbays </td>
                                                    ...
                                                    <tr>
                                                        <td><a href="herd.php">HR-111</a></td>
                                                        <td>Cowbays </td>
                                                    ...
                                                    <tr>
                                                        <td><a href="herd.php">HR-895</a></td>
                                                        <td>Cowbays </td>
