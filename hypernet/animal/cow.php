        ...
        <div class="page-content  container-fluid">
            ...
            <div class="media margin-bottom-30 bg-white padding-30 margin-top-0  card shadow light">
                <div class="media-left">
                    <img src="images/user-img5.jpg" alt="img" style="height:170px;" class=" img-bordered ">
                </div>
                            ...
                            <div class="table-responsive1">
                                <table class="table  table-condensed no-border  table-striped  margin-bottom-0">
                                    <tbody>
                                        ...
                                        <tr>
                                            <th width=""> <b> Herd Name</b> </th>
                                            <td class="text-left">Coetahs</td>
                                        </tr>

                                        <tr>
                                            <th width=""> <b> Group</b> </th>
                                            <td class="text-left">Heifers</td>
                                        </tr>
                                        <tr>
                                            <th width=""> <b>Lactation Status</b> </th>
                                                                    ...
                                                                    <div class="white">
                                                                        ...
                                                                        <div class="">
                                                                            <div class=" margin-right-15 inline">
                                                                                <i> <img src="images/icon_milk.png"
                                                                                        alt="img" height="33">
                                                                                </i>
                                                                            </div>
                                                                            <b class="font-size-14"
                                                                                style="position:relative; top:5px;">28 ltr
                                                                            </b>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="widget shadow card ">
                                                                <div
                                                                    ...
                                                                    <div class="white">
                                                                        ...
                                                                        <div class="">
                                                                            <div class=" margin-right-15 inline">
                                                                                <i> <img src="images/icon_feed.png"
                                                                                        alt="img" height="33">
                                                                                </i>
                                                                            </div>
                                                                            <b class="font-size-14"
                                                                                style="position:relative; top:5px;">12 kg
                                                                            </b>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    $(document).ready(function ($) {
                                                        (function () {
                                                            simple_line_chart = c3.generate({
                                                                ...
                                                                data: {
                                                                    columns: [
                                                                        ['Consumed', 8, 7, 8, 3, 6, 7],
                                                                        ['Produced', 8, 6, 5, 3, 5, 7],
                                                                    ],
                                                                    type: 'bar',
                                                                    groups: [
                                                                        ['Produced','Consumed']
                                ...
                                $("#mrq-dd-class1").on('change', function () {
                                    ...
                                    if (this.value.trim().toLowerCase().includes('week')) {
                                        ...
                                        simple_line_chart.load({
                                            unload: true,
                                            columns: [
                                                                        ['Consumed', 39, 52, 66, 83, 21, 17],
                                                                        ['Produced', 66, 87, 5, 123, 34, 26],
                                                                    ],
                                        });
                                    }
                                });
                                    ...
                                    <div class="vscroll padding-right-10" style="height:210px;">
                                        <div class="table-responsive ">
                                            <table class="table  margin-bottom-0 table-hover table-condensed table-bordered">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td><a href="employee.php">AC-185</a></td>
                                                    ...
                                                    <tr>
                                                        <td><a href="employee.php">AC-157</a></td>
                                                    ...
                                                    <tr>
                                                        <td><a href="employee.php">AC-855</a></td>
                                                        <td class="text-left">CW-902</td>
                                                    ...
                                                    <tr>
                                                        <td><a href="employee.php">AC-255</a></td>
                                ...
                                $("#mrq-dd-class2").on('change', function () {
                                    ...
                                    if (this.value.trim().toLowerCase().includes('week')) {
                                        ...
                                        simple_line_chart1.load({
                                            unload: true,
                                            columns: [
                                                                 ['Title 2', 132, 125, 130, 128, 127, 134, 128],
                                                            ],
                                        });
                                    }
                                });
