                            ...
                            <div class="widget  white margin-bottom-30 shadow card">
                                <div class="padding-15 bg-teal-700 " style="height:220px;">
                                    <div class="text-center padding-top-0">
                                        <div class="">
                                            <div class=" font-size-18 margin-bottom-10">Most Utilized</div>
                                            ...
                                            <div class="font-size-20  margin-bottom-15 font-weight-600" id="mrq-v1">
                                               	Warehouse 3</div>

                                            <div class="font-size-13 margin-bottom-0" id="mrq-v2"> Consignment Recived </div>
                                            <div class="font-size-18" style="    padding-bottom: 15px">
                                                <span class="font-weight-600" id="mrq-v3">204</span>
                                            </div>
                                            <div class="font-size-10">
                                                <span class="" id="mrq-v4">more than last month</span>
                                            </div>
                                            <script>
                                                $("#mrq-dd-Most").on('change', function () {
                                                    if (this.value.trim().toLowerCase().includes('month')) {
                                                       $("#mrq-v1").text('	Warehouse 3')
                                                        $("#mrq-v2").text('Consignment Recived')
                                                        $("#mrq-v3").text('204')
                        ...
                        <div class="col-lg-6">
                            <div class="widget  white margin-bottom-30 shadow card">
                                <div class="padding-15 bg-teal-700 " style="height:220px;">
                                    <div class="text-center padding-top-0">
                                        <div class="">
                                            <div class=" font-size-18 margin-bottom-10">Least Utilized</div>
                                            <div class="dropdown margin-bottom-10 ">
                                                <select type="button"
                                                    class="btn bg-teal-800 btn-block1 white dropdown-toggle btn-xs text-center "
                                            ...
                                            <div class="font-size-20  margin-bottom-15 font-weight-600" id="mrq-w1">
                                               	Warehouse 2</div>

                                            <div class="font-size-13 margin-bottom-0" id="mrq-w2"> Consignment Recived </div>
                                            <div class="font-size-18" style="    padding-bottom: 15px">
                                                <span class="font-weight-600" id="mrq-w3"><b>336</b></span>
                                            </div>
                                            <div class="font-size-10">
                                                ...
                                                $("#mrq-dd-Least").on('change', function () {
                                                    if (this.value.trim().toLowerCase().includes('month')) {
                                                       $("#mrq-w1").text('	Warehouse 2')
                                                        $("#mrq-w2").text('Consignment Recived')
                                                        $("#mrq-w3").text('336')
