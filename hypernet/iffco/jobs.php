...
-->
                                                ...
                                                <div class="inline-block pull-right   margin-bottom-10 margin-right-10">
                                                    ...
                                                    <a href="admin-jobs-iffco.php" target="_blank"
                                                        class="btn btn-sm   btn-default btn-dark">
                                                        Create Job
                                                    </a>

                                                    <a href="" onclick="window.history.go(-1); return false;"
                                                        class="  margin-left-5 btn btn-sm   btn-default ">
                                                        Back
                                                    </a>
                                                </div>
                                            </div>
                                                            ...
                                                            <td class="text-left">
                                                                <div class="media" style="max-width: 200px;">
                                                                    ...
                                                                    <div class="media-body">
                                                                        ...
                                                                        <br />
                                                                        <i class="small" Van</i> </div> </div> </td> <td
                                                                            class="text-left"> 28-May-2019, 11:20am
                                                            </td>
