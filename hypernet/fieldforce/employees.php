                                    ...
                                    <div class="text-center padding-top-0">
                                        <div class="">
                                            ...
                                            <div class="dropdown margin-bottom-5 ">
                                                <button type="button" class="btn bg-cyan-800  btn-block white dropdown-toggle "
                                                    data-toggle="dropdown">
                                                    Employee of the Month (Jan 18)
                                                    <span class="caret"></span>
                                                </button>
                                                <ul class="dropdown-menu font-size-10 text-center" style="min-width:100%;">
                                                    <li role="presentation"><a href="javascript:void(0)">Best Employee</a></li>
                                                    <li role="presentation"><a href="javascript:void(0)">Most
                                                            Violations By</a></li>

                                                </ul>
                                            </div>
                                            <img src="images/user.jpg" alt="img" style="height:80px;" class="img-circle1 img-bordered img-bordered-primary">



                                            <div>
                                                <a href="" data-toggle="popover" data-original-title="" data-trigger="hover"
                                                    data-container="body" data-placement="bottom" data-html="true" id="name1"
                                                    class="white">
                                            ...
                                            <div class="font-size-12 margin-bottom-10"> 4.5 </div>
                                            ...
                                            <table class="table  table-condensed  table-hovered    no-border   font-size-16 margin-bottom-0">
                                                <tbody>
                                                    <tr>
                                                        <td class="text-center" width="80">
                                                            <div class="margin-right-20 bg-green-100 padding-0 font-size-30 green-800">
                                                                <img src="images/icon-taskrate.png" alt="img" height="40"
                                                                    class="inline">
                                                            </div>
                                                        </td>
                                                        <td width="">
                                                    ...
                                                    <tr>
                                                        <td class="text-center">
                                                            <div class="margin-right-20 bg-green-100 padding-0 font-size-30 orange-800">
                                                                <img src="images/icon-turnover.png" alt="img" height="40"
                                                                    class="inline">
                                                            </div>
                                                        </td>
                                                        <td width="">
                                                            ...
                                                            <div class="panel-body padding-0">
                                                                <ul class="list-group list-group-bordered ">
                                                                    ...
                                                                    <li class="list-group-item">
                                                                        ...
                                                                        <div class="inline-block ">
                                                                            <div class="checkbox-custom checkbox-info margin-0 ">
                                                                                <input type="checkbox" id="Online2"
                                                                                    name="" />
                                                                                <label for="Online2">Offline</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    <li class="list-group-item">
                                                                        ...
                                                                        <div class="inline-block ">
                                                                            <div class="checkbox-custom checkbox-info margin-0 ">
                                                                                <input type="checkbox" id="Compactor"
                                                                                    name="" />
                                                                                <label for="Compactor">Technical</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    <li class="list-group-item">
                                                                        ...
                                                                        <div class="inline-block ">
                                                                            <div class="checkbox-custom checkbox-info margin-0 ">
                                                                                <input type="checkbox" id="Chain" name="" />
                                                                                <label for="Chain">Staff</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                ...
                                                <div class="form-inline">
                                                    <div class="input-icon">
                                                        <select
                                                            ...
                                                            <option data-subtext=""> Site 101
                                                            </option>
                                                            <option data-subtext=""> Site 102
                                                            </option>
                                                            <option data-subtext=""> Site 103
                                                            </option>
                                                            <option data-subtext=""> Site 104 </option>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="vscroll padding-right-0" style="height:auto;">
                                                <table class="table  table-bordered table-condensed1 table-striped1 margin-bottom-0">
                                                    <thead>
                                                        <tr class="">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-left">
                                                                <div class="margin-bottom-0  stars small">
                                                                    ...
                                                                    <span class="margin-left-10"> 4.7</span>
                                                                </div>
                                                            </td>
                                                            <td class="text-left">02</td>
                                                            <td class="text-center">
                                                                <a href="employee.php" class="btn btn-icon  btn-default btn-xs">
                                                                    View Profile
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-left">
                                                                <div class="margin-bottom-0  stars small">
                                                                    ...
                                                                    <span class="margin-left-10"> 4.5</span>
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="employee.php" class="font-weight-600">Philippe Coutinho
                                                                            </a>
                                                                            <br />
                                                            ...
                                                            <td class="text-left">
                                                                <div class="margin-bottom-0  stars small">
                                                                    ...
                                                                    <span class="margin-left-10"> 3.5</span>
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-left">
                                                                <div class="margin-bottom-0  stars small">
                                                                    ...
                                                                    <span class="margin-left-10"> 4.2</span>
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                           <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="employee.php" class="font-weight-600">Aurthr Vidal
                                                                            </a>
                                                                            <br />
                                                                            <i class="small">Staff</i>
                                                                        </div>
                                                            ...
                                                            <td class="text-left">
                                                                <div class="margin-bottom-0  stars small">
                                                                    ...
                                                                    <span class="margin-left-10"> 4.4</span>
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="employee.php" class="font-weight-600">John Dynamo
                                                                            </a>
                                                                            <br />
                                                                            <i class="small">Technical</i>
                                                                        </div>
                                                            ...
                                                            <td class="text-left">
                                                                <div class="margin-bottom-0  stars small">
                                                                    ...
                                                                    <span class="margin-left-10"> 2.9</span>
                                                                </div>
                                                            </td>
                                                            <td class="text-left">07</td>
                                                            <td class="text-center">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-left">
                                                                <div class="margin-bottom-0  stars small">
                                                                    ...
                                                                    <span class="margin-left-10"> 4.1</span>
                                                                </div>
                                                            </td>
