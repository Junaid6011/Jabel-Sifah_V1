                ...
                <div class="col-md-7">
                    ...
                    <div class="row ">
                        ...
                        <div class="col-lg-12 ">
                            ...
                            <div class="row   ">
                                <div class="col-lg-3">
                                    <div class="padding-20 margin-bottom-15 text-center bg-teal-500 white card ">
                                        <div class="font-size-14">On Route</div>
                                        ...
                                        <div class="">
                                            ...
                                            <div class="margin-bottom-5 stars  ">
                                                ...
                                                <button id="rating4" type="button"
                                                    class="btn btn-warning btn-warming btn-xs">
                                                    <span class="glyphicon glyphicon-star"></span>
                                                </button>
                                            ...
                                            <script>
                                                $("#mrq-dd-eee").on('change', function () {
                                                    ...
                                                    if (this.value.trim().toLowerCase().includes('month')) {
                                                        ...
                                                        $("#mrq-m1").text('Mr.Timro ')
                                                        $("#mrq-m2").text('3.0')
                                                        $("#mrq-m3").attr('src', 'images/user-img1.jpg')
                                                        $("#rating4").toggleClass('btn btn-default btn-warming btn-xs btn btn-warning btn-grey btn-xs');
                                                        $("#rating5").toggleClass('btn btn-default btn-warming btn-xs btn btn-default btn-grey btn-xs');
                                                    }
                                                })
                                                        ...
                                                        <tr>
                                                            <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="employee-transport.php" class="font-weight-600">Harry Los
                                                                            </a>
                                                                            <br />
                                                            ...
                                                            <td class="text-left">
                                                                <div class="margin-bottom-0  stars small">
                                                                    ...
                                                                    <span class="margin-left-10"> 3.2</span>
                                                                </div>
                                                            </td>
                                                            <td class="text-left">02</td>
                                                            <td class="text-center hidden">Driver</td>
                                                            <td class="text-center">
                                                                <a href="employee-transport.php" class="btn btn-icon  btn-default btn-xs">
                                                                    View Profile
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="employee-transport.php" class="font-weight-600">Licken Sinch
                                                                            </a>
                                                                            <br />
                                                                            <i class="small">Labour</i>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <td class="text-center hidden">labour</td>
                                                            <td class="text-center">
                                                                <a href="employee-transport.php" class="btn btn-icon  btn-default btn-xs">
                                                                    View Profile
                                                                </a>
                                                        ...
                                                        <tr>
                                                            <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="employee-transport.php" class="font-weight-600">leos Jhon
                                                                            </a>
                                                                            <br />
                                                                            <i class="small">Driver</i>
                                                                        </div>
                                                        ...
                                                        <tr>
                                                            <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="employee-transport.php" class="font-weight-600">Suzan marchnt
                                                                            </a>
                                                                            <br />
                                                                            <i class="small">Driver</i>
                                                                        </div>
                                                        ...
                                                        <tr>
                                                           <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="employee-transport.php" class="font-weight-600">Van Smith
                                                                            </a>
                                                                            <br />
                                                                            <i class="small">Driver</i>
                                                                        </div>
                                                        ...
                                                        <tr>
                                                            <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="employee-transport.php" class="font-weight-600">Sam Rich
                                                                            </a>
                                                                            <br />
                                                                            <i class="small">Driver</i>
                                                                        </div>
                                                        ...
                                                        <tr>
                                                            <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="employee-transport.php" class="font-weight-600">Mr.Timro
                                                                            </a>
                                                                            <br />
                                                                            <i class="small">Driver</i>
                                                                        </div>
