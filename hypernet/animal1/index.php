            ...
            <div class="row">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <div class="widget shadow">
                        ...
                        <div class="widget-content padding-10 bg-blue-700 height-150 text-center relative">
                          <div class="white">
                            <div class="counter-label margin-bottom-20 clearfix">
                              <span class="font-size-16">
                                Max Milk Yield: <span class="font-weight-600 pointer"> Cow: CW-72</span>
                              </span>
                            </div>
                            <div class="">
                              <span class="counter-icon margin-right-5 ">
                                <i> <img src="images/icon_milk.png" alt="img" height="60" /> </i>
                              </span>
                              <span class="counter-number font-size-20">1,800</span>
                    ...
                    <div class="col-md-6">
                      <div class="widget shadow">
                        ...
                        <div class="widget-content padding-10 bg-blue-600 height-150 text-center relative">
                          <div class="white">
                            <div class="counter-label margin-bottom-20 clearfix">
                            ...
                            <div class="">
                              <span class="counter-icon margin-right-5 ">
                                <i> <img src="images/icon_feed.png" alt="img" height="60" /> </i>
                              </span>
                              <span class="counter-number font-size-20">180</span>
                              <span class="counter-number-related font-size-12">kg</span>
                            </div>
                            <div class="font-size-10">
                              <span class="margin-right-5"><i class="ion-arrow-graph-down-right"></i></span> <span class="">14%</span><span class=""> less than last week</span>
                            </div>
                            <span class="label white absolute bg-blue-700  flat right bottom">
                              This Week
                            </span>
                          </div>
                        </div>
                ...
                <div class="col-lg-2">
                    <div class="widget  margin-bottom-30 shadow">
                        <div class="widget-content   bg-red-700 " style="height:270px;">
                            ...
                            <div class="counter counter-md counter-inverse text-center padding-top-0">
                                <div class="bg-red-800 padding-15 margin-bottom-10 height-210" >
                                    <div class="font-size-14 margin-bottom-5"> <b class="text-uppercase"> Current Milk Yield </b> <br />  <div class="label bg-red-700">This Month</div></div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="panel panel-default  card light">
                            <div class="panel-heading margin-bottom-0">
                                <h3 class="panel-title font-weight-600">Current Week Alerts</h3>
                                <div class="panel-actions">
                                                    ...
                                                    (function () {
                                                        ...
                                                        var chart = c3.generate({
                                                            ...
                                                            data: {
                                                                ...
                                                                columns: [
                                                                    ['Estrus', 10, 11, 10, 2, 5, 8, 5, 5, 2, 9],
                                                                    ['Lameness', 10, 17, 1, 5, 6, 8, 9, 15, 1, 5],
                                                                    ['Rumination', 3, 1, 1, 2, 5, 8, 9, 5, 5, 3],
                                                                    ['Temperature', 10, 11, 10, 2, 5, 8, 5, 5, 2, 9],
                                    ...
                                    <div class="text-right   margin-bottom-10">
                                        <div class="btn-group btn-group-sm btn-group-xs" data-toggle="buttons">
                                            ...
                                            <label class="btn btn-outline btn-success ">
                                                <input type="radio" name="multiples" value="banana" checked=""> This Week
                                            </label>
                                            <label class="btn btn-outline btn-success active">
                                                <input type="radio" name="multiples">  This Month
                                            </label>
                                            <label class="btn btn-outline btn-success">
                                                <input type="radio" name="multiples" checked=""> This Year
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 ">
                                            <p class="clearfix font-size-18 margin-bottom-10">
                                                ...
                                                <span class="pull-right "><a class="icon btn btn-info btn-xs " data-toggle="tooltip" data-original-title="View All"> View All</a></span>
                                            </p>
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default  card light">
                                <div class="panel-heading">
                                    <h3 class="panel-title font-weight-600">Current Week Activities</h3>
                                    <div class="panel-actions">
                                        <a class="panel-action icon " data-toggle="tooltip" data-original-title="View All"> View All</a>
                                        <a class="panel-action icon ion-loop" data-toggle="tooltip" data-original-title="Refresh"></a>
                                    </div>
