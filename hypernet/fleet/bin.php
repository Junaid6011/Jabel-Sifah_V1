    ...
    <div class="page">
        ...
        <div class="page-content  container-fluid">
            ...
            <div class="media margin-bottom-30 bg-white padding-30 margin-top-0  card shadow light">
                <div class="media-left">
                    <img src="images/bin-img.png" alt="img" style="height:200px;" class="img-bordered ">
                </div>
                <div class="media-body">
                    <h3 class="font-weight-600 margin-top-0">BIN0815 (E20000166609016819604E12) </h3>
                    <div class="font-size-14">Type: Solid</div>


                    <div class="row">
                        <div class="col-sm-4">
                            <br /> <br /> <br />
                            <h4 class="margin-bottom-10">Current Area</h4>
                            <h2 class=" font-size-14 margin-top-0">Blue Road, Malburg, 1.1- AL QUOZ</h2>
                        </div>
                        <div class="col-sm-4">
                            <div class="table-responsive1">
                                <table class="table  table-condensed1 no-border1  table-striped1  margin-bottom-0">
                                    <tbody>
                                        <tr>
    ...
    <div class="row no-space1">
        <div class="col-md-4">
            <div class="widget shadow card">
                <div class=" padding-top-0 pa bg-blue-800 vertical-align height-100 white  text-center relative ">
                    <div class="vertical-align-middle">
                        <div class="margin-bottom-0 ">

                            <div class="font-size-14 margin-bottom-5 ">Current Fill Level</div>
                            <div class="margin-bottom-5"> <img src="images/icon-online.png" alt="img"
                                    height="24"> </div>
                        </div>
                        <b class="font-size-18">90% </b>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class=" padding-top-0 pa bg-red-800 vertical-align height-100 white  text-center relative ">
                    <div class="vertical-align-middle">
                        <div class="margin-bottom-0 ">
                            ...
                            <div class="font-size-14 margin-bottom-5 ">Last Collection</div>
                            <div class="margin-bottom-5"> <img src="images/icon-offline.png" alt="img"
                                    height="24"> </div>
                        </div>
                        <b class="font-size-12"> 25-Jan-2019, 08:00am</b>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class=" padding-top-0 pa bg-green-800 vertical-align height-100 white  text-center relative ">
                    <div class="vertical-align-middle">
                        <div class="margin-bottom-0 ">
                            ...
                            <div class="font-size-14 margin-bottom-5 ">Last Updated</div>
                            <div class="margin-bottom-5"> <img src="images/icon-offline.png" alt="img"
                                    height="24"> </div>
                        </div>
                        <b class="font-size-12"> 25-Jan-2019, 08:00am</b>
                    ...
                    <div class="slikslider text-center  " id="slikslider-live">
                        ...
                        <div>
                            <div class="white text-center">
                                Battery
                                <br />
                                <div class="battery" title="95%"> <span style="width: 44%;"></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            <div class="white">
                                Net Weight
                                <div class="font-size-14 font-weight-600">0.00 kg</div>
                            </div>
                        </div>
                        <div>
                            <div class="white">
                    ...
                    <div class="panel panel-default  padding-0  card shadow light " style="min-height: 200px;">
                        <div class="panel-heading font-weight-600 margin-bottom-0">
                            <ul class="nav nav-tabs nav-tabs-line" data-plugin="nav-tabs" role="tablist">
                                <li class=""><a data-toggle="tab" href="#Summary"> Details</a></li>
                                                                        ...
                                                                        (function () {
                                                                            var simple_line_chart = c3.generate({
                                                                                ...
                                                                                data: {
                                                                                    ...
                                                                                    columns: [
                                                                                        ['Waste', 120, 140, 150, 120, 80, 90, 120, 140, 150, 120, 80, 90],
                                                                                        ['Collection', 80, 100, 80, 60, 80, 60, 99, 120, 144, 100, 60, 80],
                                                        ...
                                                        <div class="panel-heading margin-bottom-0 ">
                                                            ...
                                                            <div class="panel-actions">
                                                                <span data-toggle="tooltip" data-original-title="Full Screen">
                                                                    <a class="panel-action icon wb-expand" data-target="#mapfull"
                                                                        data-toggle="modal"></a>
                                                                </span>
                                                        ...
                                                        <table class="table table-striped table-condensed  table-bordered   margin-bottom-0">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="label label-info "> InProgress</div>
                                                                    </td>
                                                                    <td class="text-left">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="employee.php" class="font-weight-600">Andrew McDorment
                                                                            </a>
                                                                            <br />
                                                ...
                                                <table class="table  margin-bottom-0 table-hover table-condensed table-bordered   "
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="text-left">02-Feb-2019, 02:20am </td>
                                                            ...
                                                            <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="fleet.php" class="font-weight-600">JHB342
                                                                            </a>
                                                                            <br />
                                                            ...
                                                            <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="employee.php" class="font-weight-600">Luke Ronchi
                                                                            </a>
                                                                            <br />
                                                                            <i class="small">Manager</i>
                                                                        </div>
                                                            ...
                                                            <td class="text-left"> Canal View Road </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-left">12-April-2019, 10:00am </td>
                                                            ...
                                                            <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="fleet.php" class="font-weight-600">JSI732
                                                                            </a>
                                                                            <br />
                                                            ...
                                                            <td class="text-left">Kurral Road , North </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="fleet.php" class="font-weight-600">SUI632
                                                                            </a>
                                                                            <br />
                                                            ...
                                                            <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="employee.php" class="font-weight-600">David Octanga
                                                                            </a>
                                                                            <br />
                                                                            <i class="small">Driver</i>
                                                                        </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-left">12June-2019, 10:00am </td>
                                                           ...
                                                           <td class="text-left">
                                                            ...
                                                            <td class="text-left">Mountain Road, East </td>
                                                ...
                                                <table class="table  margin-bottom-0 table-hover table-condensed table-bordered   "
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="text-left">16-March-2019, 0920am </td>
                                                            <td class="text-left">97</td>
                                                            <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        <div class="media-left padding-right-10">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="fleet.php" class="font-weight-600">PSA216
                                                                            </a>
                                                                            <br />
                                                                            <i class="small">Chain Loader</i>
                                                                        </div>
                                                            ...
                                                            <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="employee.php" class="font-weight-600">Mike Tison
                                                                            </a>
                                                                            <br />
                                                                            <i class="small">Staff</i>
                                                                        </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-left">26-Feb-2019, 03:38am </td>
                                                            ...
                                                            <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="fleet.php" class="font-weight-600">HHJ872
                                                                            </a>
                                                                            <br />
                                                                            <i class="small">Compactor</i>
                                                                        </div>
                                                            ...
                                                            <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="employee.php" class="font-weight-600">Mike Hussey
                                                                            </a>
                                                                            <br />
                                                                            <i class="small">Driver</i>
                                                                        </div>
                                                            ...
                                                            <td class="text-left">Blue Area Road, Malburg </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-left">12-June-2019, 11:30am </td>
                                                            ...
                                                            <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="fleet.php" class="font-weight-600">SDS322
                                                                            </a>
                                                                            <br />
                                                                            <i class="small">Hook Loader</i>
                                                                        </div>
                                                            ...
                                                            <td class="text-left">Mountain View Road </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="fleet.php" class="font-weight-600">HJS652
                                                                            </a>
                                                                            <br />
                                                                            <i class="small">Chain Loader</i>
                                                                        </div>
                                                            ...
                                                            <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="employee.php" class="font-weight-600">Bhencroft
                                                                            </a>
                                                                            <br />
                                                                            <i class="small">Manager</i>
                                                                        </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-left">09-July-2019, 02:00am </td>
                                                            <td class="text-left">75</td>
                                                            <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        <div class="media-left padding-right-10">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="fleet.php" class="font-weight-600">HSU524
                                                                            </a>
                                                                            <br />
                                                                            <i class="small">Tipper</i>
                                                                        </div>
                                                           ...
                                                           <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="employee.php" class="font-weight-600">Andrew Hussey
                                                                            </a>
                                                                            <br />
                                                                            <i class="small">Staff</i>
                                                                        </div>
                                                            ...
                                                            <td class="text-left">Skylark Road, West  </td>
                                                ...
                                                <table class="table  margin-bottom-0 table-hover table-condensed table-bordered   "
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="text-left">04-July-2019, 10:00am </td>
                                                            <td class="text-left">86</td>
                                                            <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        <div class="media-left padding-right-10">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="fleet.php" class="font-weight-600">HYI875
                                                                            </a>
                                                                            <br />
                                                                            <i class="small">Compactor</i>
                                                                        </div>
                                                           ...
                                                           <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="employee.php" class="font-weight-600">Alison
                                                                            </a>
                                                                            <br />
                                                                            <i class="small">Staff</i>
                                                                        </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-left">09-Jan-2019, 09:00am </td>
                                                            ...
                                                            <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="employee.php" class="font-weight-600">Renshaw
                                                                            </a>
                                                                            <br />
                                                                            <i class="small">Manager</i>
                                                                        </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-left">11-July-2019, 12:30am </td>
                                                            ...
                                                            <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="fleet.php" class="font-weight-600">HUS782
                                                                            </a>
                                                                            <br />
                                                                            <i class="small">Hook Loader</i>
                                                                        </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="fleet.php" class="font-weight-600">HHT542
                                                                            </a>
                                                                            <br />
                                                                            <i class="small">Tipper</i>
                                                                        </div>
                                                            ...
                                                            <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="employee.php" class="font-weight-600">George
                                                                            </a>
                                                                            <br />
                                                                            <i class="small">Driver</i>
                                                                        </div>
