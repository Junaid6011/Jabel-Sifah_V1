                                    ...
                                    <div class="text-center padding-top-0">
                                        <div class="">
                                            ...
                                            <div class="dropdown margin-bottom-20 ">
                                                <button type="button" class="btn bg-teal-800 btn-block white dropdown-toggle btn-xs"
                                            ...
                                            <div class="font-size-20  margin-bottom-10 font-weight-600"> MR899</div>

                                            <div class="font-size-14 margin-bottom-10"> 23 Violations </div>
                                ...
                                <div class="padding-15 bg-cyan-700 " style="height:220px;">
                                    <div class="text-center padding-top-0">
                                        <div class="">
                                            ...
                                            <div class="dropdown margin-bottom-20 ">
                                                <button type="button" class="btn bg-cyan-800 btn-block white dropdown-toggle btn-xs"
                                                    data-toggle="dropdown">
                                                    This Week
                                                    <span class="caret"></span>
                                                </button>
                                            ...
                                            <div class="font-size-20  margin-bottom-10 font-weight-600"> LZ189</div>
                                                                        ...
                                                                        <div class="inline-block ">
                                                                            <div class="checkbox-custom checkbox-info margin-0 ">
                                                                                <input type="checkbox" id="Compactor"
                                                                                    name="" />
                                                                                <label for="Compactor">Compactor</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    <li class="list-group-item">
                                                                        <span class="badge badge-default">70</span>
                                                                        <div class="inline-block ">
                                                                            <div class="checkbox-custom checkbox-info margin-0 ">
                                                                                <input type="checkbox" id="Chain" name="" />
                                                                                <label for="Chain">Chain Loader</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    <li class="list-group-item">
                                                                        ...
                                                                        <div class="inline-block ">
                                                                            <div class="checkbox-custom checkbox-info margin-0 ">
                                                                                <input type="checkbox" id="Tipper" name="" />
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="vscroll padding-right-0" style="height:auto;">
                                                    <table class="table  table-bordered table-hover table-condensed1 table-striped1 margin-bottom-0">
                                                        <thead>
                                                            <tr class="">
                                                                ...
                                                                <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="fleet.php" class="font-weight-600">GSD238
                                                                            </a>
                                                                            <br />
