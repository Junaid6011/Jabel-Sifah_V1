...
<body class="layout-boxed admin-bg ">
    ...
    <div class="page1 bg-white">
        <div class="page-header">
            <h1 class="page-title">Dumpsite</h1>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-icon">
                                            <select class="form-control selectpicker " data-width="100%" data-size="5"
                                                ...
                                                <option data-subtext=""> Dumpsite </option>
                                                <option data-subtext=""> Dumpsite1 </option>
                                                <option data-subtext=""> Dumpsite2 </option>
                                                <option data-subtext=""> Dumpsite3 </option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
