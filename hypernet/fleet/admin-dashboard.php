        ...
        <div class="page-content  ">
            ...
            <div class="padding-0">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <a href="admin-location.php" class="grey-700">
                            <div class="padding-15 bg-primary-100 text-center card  margin-bottom-30">
                                <div class="margin-bottom-10    primary-800">
                                    <img src="images/icon_leftmenu_territorirs.png" alt="img" width="20">
                                </div>
                                <span class=" font-weight-600 text-uppercase ">Location/Territories</span>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-md-3">
                        <a href="admin-customer.php" class="grey-700">
                            <div class="padding-15 bg-primary-100 text-center card  margin-bottom-30">
                                ...
                                <span class=" font-weight-600 text-uppercase ">Client/Contract</span>
                            </div>
                        </a>
                    </div>

                     <div class="col-md-3">
                        <a href="admin-dumpsite.php" class="grey-700">
                            <div class="padding-15 bg-primary-100 text-center card  margin-bottom-30">
                                <div class="margin-bottom-10    primary-800">
                                <img src="images/icon_leftmenu_territorirs.png" alt="img" width="20">
                                </div>
