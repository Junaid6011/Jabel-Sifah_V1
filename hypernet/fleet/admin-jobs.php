                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="Collection" placeholder="..." />
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control selectpicker " data-width="100%" data-size="5"
                                            title="Select Priority" data-style="btn-select" data-live-search="false">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control selectpicker " data-width="100%" data-size="5"
                                            title="Select Activity Type" data-style="btn-select" data-live-search="false">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control selectpicker " data-width="100%" data-size="5"
                                            title="Select Routine Type" data-style="btn-select" data-live-search="false">
                                            <option>Daily </option>
                                ...
                                <tr>
                                    ...
                                    <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="employee.php" class="font-weight-600">Mark Nicholas
                                                                            </a>
                                                                            <br />
                                                                            <i class="small">Manager</i>
                                                                        </div>
