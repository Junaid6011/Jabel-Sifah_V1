                                    ...
                                    <div class="padding-15 bg-teal-700 " style="height:220px;">
                                        <div class="text-center padding-top-0">
                                            <div class="">
                                                ...
                                                <div class="font-size-14 margin-bottom-10" id="mrq-v2"> 2530 Consignments </div>
                                                ...
                                                <script>
                                                    $("#mrq-dd-Most").on('change', function () {
                                                        if (this.value.trim().toLowerCase().includes('month')) {
                                                            $("#mrq-v1").text('	Franchise 3')
                                                            $("#mrq-v2").text('2530 Consignments')
                                                            //                                                        $("#mrq-v3").text('17%')
                                                            $("#mrq-v4").text('13% more than last month')
                                                        }
                                                        else {
                                                            $("#mrq-v1").text('	Franchise 1')
                                                            $("#mrq-v2").text('27820 Consignments')
                                                            //                                                        $("#mrq-v3").text('17%')
                                    ...
                                    <div class="padding-15 bg-teal-700 " style="height:220px;">
                                        <div class="text-center padding-top-0">
                                            <div class="">
                                                ...
                                                <div class="font-size-14 margin-bottom-10" id="mrq-vv2">1780 Consignments</div>
                                                <div class="font-size-10">
                                                    <!--
                                                <span class="margin-right-5"><i
                                                        class="ion-arrow-graph-up-right"></i></span>
...
-->
                                                ...
                                                <script>
                                                    $("#mrq-dd-Least").on('change', function () {
                                                        if (this.value.trim().toLowerCase().includes('month')) {
                                                            $("#mrq-w1").text('	Franchise 2')
                                                            $("#mrq-vv2").text('1780 Consignments')
                                                            //                                                        $("#mrq-v3").text('17%')
                                                            $("#mrq-w4").text('17% more than last month')
                                                        }
                                                        else {
                                                            $("#mrq-w1").text('	Franchise 4')
                                                            $("#mrq-vv2").text('11780 Consignments')
                                                            //                                                        $("#mrq-v3").text('17%')
                                            ...
                                            <div class="padding-0 margin-top-20 bg-white  text-center">
                                                <div class=" ">
                                                    <div class="text-uppercase font-size-14 margin-bottom-5">Average
                                                        Time
                                                        Between Franchise to Destination</div>
                                                    <div class="margin-bottom-10">
