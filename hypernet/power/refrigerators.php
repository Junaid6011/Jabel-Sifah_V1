                                    ...
                                    <div class="white">
                                        ...
                                        <div class="">
                                            <div class=" margin-right-15 inline">
                                                <i> <img src="images/icon-leftmenu-fridge-white.png" alt="img" height="40"> </i>
                                            </div>
                                ...
                                <div class="padding-15 bg-cyan-700 " style="height:220px;">
                                    <div class="text-center padding-top-0">
                                        <div class="">
                                            ...
                                            <div class="font-size-14 margin-bottom-10" id="mrq-w2"> 13 Errors Occurs
                                            </div>
                                            <div class="font-size-10">
                                                <span class="margin-right-5"><i
                                                        class="ion-arrow-graph-up-right"></i></span>
                                                <span class="" id="mrq-w3">13%</span>
                                                                        ...
                                                                        <div class="inline-block margin-right-20 ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox" id="qqqy"
                                                                                    name="" />
                                                                                <label for="qqqy">Tower refrigerator</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    <li class="list-group-item padding-0 ">
                                                                        <div class="inline-block margin-right-20 ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox" id="qqqu"
                                                                                    name="" />
                                                                                <label for="qqqu">Rack refrigerator</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    <li class="list-group-item padding-0 ">
                                                                        ...
                                                                        <div class="inline-block margin-right-20 ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox" id="111n"
                                                                                    name="" />
                                                                                <label for="111n">Rack refrigerator</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    <li class="list-group-item padding-0 ">
                                                                        ...
                                                                        <div class="inline-block margin-right-20 ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox" id="qqqw"
                                                                                    checked />
                                                                                <label for="qqqw">Tower refrigerator</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    <li class="list-group-item padding-0 ">
                                                                        ...
                                                                        <div class="inline-block margin-right-20 ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox" id="111e"
                                                                                    checked />
                                                                                <label for="111e">Rack refrigerator</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    <li class="list-group-item padding-0 ">
                                                                        <div class="inline-block margin-right-20 ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox" id="222e"
                                                                                    checked />
                                                                                <label for="222e"> Tower refrigerator</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    <li class="list-group-item padding-0 ">
                                                                        ...
                                                                        <div class="inline-block ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox" id="Hook"
                                                                                    value="Tower refrigerator">
                                                                                <label for="Hook">Tower refrigerator
                                                                                </label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                        ...
                                                                        <div class="inline-block ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox" id="Compactor"
                                                                                    value="Rack refrigerator">
                                                                                <label for="Compactor">Rack refrigerator</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                    ...
                                                    <table
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            ...
                                                                            <br />
                                                                            <i class="small"> Tower refrigerator</i>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <td class="text-center hidden">Tower refrigerator </td>
                                                                <td class="text-center">
                                                                    <button type="button"
                                                            ...
                                                            <tr>
                                                                <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            ...
                                                                            <br />
                                                                            <i class="small">Rack refrigerator</i>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <td class="text-center hidden">Rack refrigerator </td>
                                                                <td class="text-left">
