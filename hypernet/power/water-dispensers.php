                                    ...
                                    <div class="white">
                                        <div class="margin-bottom-10   ">
                                            <div class="font-size-14 ">
                                                Total Water Dispensers
                                            </div>
                                        </div>
                                        <div class="">
                                            <div class=" margin-right-15 inline">
                                                <i> <img src="images/icon-dispensor.png" alt="img" height="40"> </i>
                                            </div>
                                            ...
                                            <div class="widget margin-0 ">
                                                <div class=" padding-10   height-90 text-center relative">
                                                    <div class="white">
                                                        <div class="margin-bottom-0 ">
                                                            <div class="font-size-14 ">
                                                                Rack Water Dispensers
                                                            </div>
                                                        </div>
                                                        <div class="">
                                                            <b class="font-size-18"> 110 </b>
                                                        </div>
                                                        <div
                                                            class="label white  bg-teal-600 absolute1  left right bottom">
                                                            31 In Use
                                ...
                                <div class="padding-15 bg-cyan-700 " style="height:220px;">
                                    <div class="text-center padding-top-0">
                                        <div class="">
                                            ...
                                            <div class="font-size-14 margin-bottom-10" id="mrq-w2"> 15 Errors Occurs
                                            </div>
                                            <div class="font-size-10">
                                                <span class="margin-right-5"><i
                                                        class="ion-arrow-graph-up-right"></i></span>
                                                <span class="" id="mrq-w3">19%</span>
                                        ...
                                        <script>
                                            $("#mrq-dd-Errors").on('change', function () {
                                                ...
                                                if (this.value.trim().toLowerCase().includes('month')) {
                                                    $("#mrq-w1").text('WH-562')
                                                    $("#mrq-w2").text('15 Errors Occurs')
                                                    $("#mrq-w3").text('19%')
                                                    $("#mrq-w4").text('more than last month')
                                                }
                                                else {
                                                    $("#mrq-w1").text('	WH-822')
                                                    $("#mrq-w2").text('07 Errors Occurs')
                                                    $("#mrq-w3").text('19%')
                                                                        ...
                                                                        <div class="inline-block margin-right-20 ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox" id="qqqy"
                                                                                    name="" />
                                                                                <label for="qqqy">Tower Water Dispensers</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    <li class="list-group-item padding-0 ">
                                                                        <div class="inline-block margin-right-20 ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox" id="qqqu"
                                                                                    name="" />
                                                                                <label for="qqqu">Rack Water Dispensers</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    <li class="list-group-item padding-0 ">
                                                                        ...
                                                                        <div class="inline-block margin-right-20 ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox" id="111n"
                                                                                    name="" />
                                                                                <label for="111n">Rack Water Dispensers</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    <li class="list-group-item padding-0 ">
                                                                        ...
                                                                        <div class="inline-block margin-right-20 ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox" id="qqqw"
                                                                                    checked />
                                                                                <label for="qqqw">Tower Water Dispensers</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    <li class="list-group-item padding-0 ">
                                                                        ...
                                                                        <div class="inline-block margin-right-20 ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox" id="111e"
                                                                                    checked />
                                                                                <label for="111e">Rack Water Dispensers</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    <li class="list-group-item padding-0 ">
                                                                        <div class="inline-block margin-right-20 ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox" id="222e"
                                                                                    checked />
                                                                                <label for="222e"> Tower Water Dispensers</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    <li class="list-group-item padding-0 ">
                                                                        ...
                                                                        <div class="inline-block ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox" id="Hook"
                                                                                    value="Tower Water Dispensers">
                                                                                <label for="Hook">Tower Water Dispensers
                                                                                </label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                        ...
                                                                        <div class="inline-block ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox" id="Compactor"
                                                                                    value="Rack Water Dispensers">
                                                                                <label for="Compactor">Rack Water Dispensers</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                    ...
                                                    <table
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            ...
                                                                            <br />
                                                                            <i class="small"> Tower Water Dispensers</i>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <td class="text-center hidden">Tower Water Dispensers </td>
                                                                <td class="text-center">
                                                                    <button type="button"
                                                            ...
                                                            <tr>
                                                                <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        <div class="media-left padding-right-10">
                                                                            <img src="images/water-dispensor.png"
                                                                                class="img-bordered"
                                                                                style="height:36px; width:36px;">
                                                                        </div>
                                                                        <div class="media-body">
                                                                            ...
                                                                            <br />
                                                                            <i class="small">Rack Water Dispensers</i>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <td class="text-center hidden">Rack Water Dispensers </td>
                                                                <td class="text-left">
