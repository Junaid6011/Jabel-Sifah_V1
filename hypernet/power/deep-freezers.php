                                    ...
                                    <div class="white">
                                        ...
                                        <div class="">
                                            <div class=" margin-right-15 inline">
                                                <i> <img src="images/icon-deep-freezer_white.png" alt="img" height="40"> </i>
                                            </div>
                                                                        ...
                                                                        <div class="inline-block margin-right-20 ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox" id="qqqy"
                                                                                    name="" />
                                                                                <label for="qqqy">Tower Deep Freezer</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    <li class="list-group-item padding-0 ">
                                                                        <div class="inline-block margin-right-20 ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox" id="qqqu"
                                                                                    name="" />
                                                                                <label for="qqqu">Rack Deep Freezer</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    <li class="list-group-item padding-0 ">
                                                                        ...
                                                                        <div class="inline-block margin-right-20 ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox" id="111n"
                                                                                    name="" />
                                                                                <label for="111n">Rack Deep Freezer</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    <li class="list-group-item padding-0 ">
                                                                        ...
                                                                        <div class="inline-block margin-right-20 ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox" id="qqqw"
                                                                                    checked />
                                                                                <label for="qqqw">Tower Deep Freezer</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    <li class="list-group-item padding-0 ">
                                                                        ...
                                                                        <div class="inline-block margin-right-20 ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox" id="111e"
                                                                                    checked />
                                                                                <label for="111e">Rack Deep Freezer</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    <li class="list-group-item padding-0 ">
                                                                        <div class="inline-block margin-right-20 ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox" id="222e"
                                                                                    checked />
                                                                                <label for="222e"> Tower Deep Freezer</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    <li class="list-group-item padding-0 ">
                                                                        ...
                                                                        <div class="inline-block ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox" id="Hook"
                                                                                    value="Tower Deep Freezer">
                                                                                <label for="Hook">Tower Deep Freezer
                                                                                </label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                        ...
                                                                        <div class="inline-block ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox" id="Compactor"
                                                                                    value="Rack Deep Freezer">
                                                                                <label for="Compactor">Rack Deep Freezer</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                    ...
                                                    <table
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        <div class="media-left padding-right-10">
                                                                            <img src="images/deep-freezer.png"
                                                                                class="img-bordered"
                                                                        ...
                                                                        <div class="media-body">
                                                                            ...
                                                                            <br />
                                                                            <i class="small"> Tower Deep Freezer</i>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <td class="text-center hidden">Tower Deep Freezer </td>
                                                                <td class="text-center">
                                                                    <button type="button"
                                                            ...
                                                            <tr>
                                                                <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        <div class="media-left padding-right-10">
                                                                            <img src="images/deep-freezer1.png"
                                                                                class="img-bordered"
                                                                                style="height:36px; width:36px;">
                                                                        </div>
                                                                        <div class="media-body">
                                                                            <a href="deep-freezer.php"
                                                                                class="font-weight-600">HC-624
                                                                            </a>
                                                                            <br />
                                                                            <i class="small">Rack Deep Freezer</i>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <td class="text-center hidden">Rack Deep Freezer </td>
                                                                <td class="text-left">
