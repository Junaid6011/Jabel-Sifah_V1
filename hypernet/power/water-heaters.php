                                ...
                                <div class="padding-15 bg-cyan-700 " style="height:220px;">
                                    <div class="text-center padding-top-0">
                                        <div class="">
                                            ...
                                            <div class="font-size-14 margin-bottom-10" id="mrq-w2"> 11 Errors Occurs
                                            </div>
                                                                        ...
                                                                        <div class="inline-block margin-right-20 ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox" id="qqqy"
                                                                                    name="" />
                                                                                <label for="qqqy">Tower Water Heater</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    <li class="list-group-item padding-0 ">
                                                                        <div class="inline-block margin-right-20 ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox" id="qqqu"
                                                                                    name="" />
                                                                                <label for="qqqu">Rack Water Heater</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    <li class="list-group-item padding-0 ">
                                                                        ...
                                                                        <div class="inline-block margin-right-20 ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox" id="111n"
                                                                                    name="" />
                                                                                <label for="111n">Rack Water Heater</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    <li class="list-group-item padding-0 ">
                                                                        ...
                                                                        <div class="inline-block margin-right-20 ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox" id="qqqw"
                                                                                    checked />
                                                                                <label for="qqqw">Tower Water Heater</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    <li class="list-group-item padding-0 ">
                                                                        ...
                                                                        <div class="inline-block margin-right-20 ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox" id="111e"
                                                                                    checked />
                                                                                <label for="111e">Rack Water Heater</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    <li class="list-group-item padding-0 ">
                                                                        <div class="inline-block margin-right-20 ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox" id="222e"
                                                                                    checked />
                                                                                <label for="222e"> Tower Water Heater</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    <li class="list-group-item padding-0 ">
                                                                        ...
                                                                        <div class="inline-block ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox" id="Hook"
                                                                                    value="Tower Water Heater">
                                                                                <label for="Hook">Tower Water Heater
                                                                                </label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                        ...
                                                                        <div class="inline-block ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox" id="Compactor"
                                                                                    value="Rack Water Heater">
                                                                                <label for="Compactor">Rack Water Heater</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                    ...
                                                    <table
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="water-heater.php"
                                                                                class="font-weight-600">HC-33
                                                                            </a>
                                                                            <br />
                                                                            <i class="small"> Tower Water Heater</i>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <td class="text-center hidden">Tower Water Heater </td>
                                                                <td class="text-center">
                                                                    <button type="button"
                                                            ...
                                                            <tr>
                                                                <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            ...
                                                                            <br />
                                                                            <i class="small">Rack Water Heater</i>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <td class="text-center hidden">Rack Water Heater </td>
                                                                <td class="text-left">
