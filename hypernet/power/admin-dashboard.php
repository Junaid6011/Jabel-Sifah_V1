    ...
    <div class="page1 bg-white">
        ...
        <div class="page-content  ">
            ...
            <div class="padding-0">
                ...
                <div class="row">
                <div class="col-md-4">
                        <a href="admin-devices.php" class="grey-700">
                            <div class="padding-15 bg-primary-100 text-center card  margin-bottom-30">
                                <div class="margin-bottom-10    primary-800">
                                    <img src="images/icon-leftmenu-devices.png" alt="img" width="20">
                                </div>
                                <span class=" font-weight-600 text-uppercase ">Devices</span>
                            </div>
                        </a>
                    </div>
                    <!-- <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <a href="admin-employees.php" class="grey-700">
                            <div class="padding-15 bg-primary-100 text-center card  margin-bottom-30">
                                ...
                                <span class=" font-weight-600 text-uppercase ">employee</span>
                            </div>
                        </a>
                    </div>
                    <div class="col-md-4">
                        <a href="admin-maintenances.php" class="grey-700">
                            <div class="padding-15 bg-primary-100 text-center card  margin-bottom-30">
                                ...
                                <span class=" font-weight-600 text-uppercase ">maintenances</span>
                            </div>
                        </a>
                    </div>
                    <!-- <div class="col-md-4">
                        <a href="admin-fleet.php" class="grey-700">
                            <div class="padding-15 bg-primary-100 text-center card  margin-bottom-30">
                                <div class="margin-bottom-10    primary-800">
                                    <img src="images/icon_leftmenu_maintenances.png" alt="img" width="20">
                                </div>
                    ...
                    <div class="col-md-4">
                        <a href="admin-customer.php" class="grey-700">
                            <div class="padding-15 bg-primary-100 text-center card  margin-bottom-30">
                                ...
                                <span class=" font-weight-600 text-uppercase ">Customer/Contracts</span>
                            </div>
                        </a>
                    </div> -->
