                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-icon">
                                            <select class="form-control selectpicker " data-width="100%" data-size="5"
                                                ...
                                                <option data-subtext=""> Compactor </option>
                                                <option data-subtext=""> Hook Loader </option>
                                                <option data-subtext=""> Chain Loader </option>
                                                <option data-subtext=""> Tipper </option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-left">
                                        <div class="media" style="max-width: 200px;">
                                            ...
                                            <div class="media-body">
                                                <a href="fleet.php" class="font-weight-600">AQA232
                                                </a>
                                                <br />
                                ...
                                <tr>
                                    ...
                                    <td class="text-left">
                                        <div class="media" style="max-width: 200px;">
                                            <div class="media-left padding-right-10">
                                                <img src="images/icon-truck-photo3.png" class="img-bordered"
                                                    style="height:36px">
                                            </div>
                                            <div class="media-body">
