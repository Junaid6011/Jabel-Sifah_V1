                                ...
                                <div class="padding-15 bg-teal-700 " style="height:220px;">
                                    <div class="text-center padding-top-0">
                                        <div class="">
                                            ...
                                            <div class="font-size-14 margin-bottom-10" id="mrq-x2"> 09 Violations </div>
                                            <div class="font-size-10">
                                                <span class="margin-right-5"><i
                                                        class="ion-arrow-graph-up-right"></i></span>
                                            ...
                                            <script>
                                                $("#mrq-dd-Maintences").on('change', function () {
                                                    if (this.value.trim().toLowerCase().includes('month')) {
                                                        $("#mrq-x1").text('  TMR 980 ')
                                                        $("#mrq-x2").text('09 Violations')
                                                        $("#mrq-x3").text('17%')
                                                        $("#mrq-x").text('more than yesterday')
                                                    }
                                                    else {
                                                        $("#mrq-x1").text('	PEO 985 ')
                                                        $("#mrq-x2").text('07 Violations')
                                                        $("#mrq-x3").text('09%')
                                                                ...
                                                                <ul class="list-group list-group-bordered mrq-cb"
                                                                    ...
                                                                    <li class="list-group-item">
                                                                        ...
                                                                        <div class="inline-block ">
                                                                            <div
                                                                                class="checkbox-custom checkbox-info margin-0 ">
                                                                                <input type="checkbox" id="Hook Loader"
                                                                                    value="Hook Loader">
                                                                                <label for="Hook Loader">Hook Loader
                                                                                </label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    ...
                                                                    <li class="list-group-item">
                                                                        ...
                                                                        <div class="inline-block ">
                                                                            <div
                                                                                class="checkbox-custom checkbox-info margin-0 ">
                                                                                <input type="checkbox" id="Chain Loader"
                                                                                    value="Chain Loader">
                                                                                <label for="Chain Loader">Chain Loader</label>
                                                                            </div>
                                                                        </div>
                                                    ...
                                                    <table class="table  table-bordered table-hover table-condensed1 table-striped1 margin-bottom-0" id="table">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="text-center hidden">Hook Loader</td>
                                                                <td class="text-center">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center hidden">Compactor</td>
                                                                <td class="text-center">
                                                                    <button type="button" class="btn btn-icon  btn-default btn-xs collapsed"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center hidden">Tipper</td>
                                                                <td class="text-center">
                                                                    <button type="button" class="btn btn-icon  btn-default btn-xs collapsed"
