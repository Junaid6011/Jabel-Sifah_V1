        ...
        <div class="page-content  container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-9  ">
                    ...
                    <div class="panel panel-default  card shadow light">
                        <div class="panel-heading">
                            <h3 class="panel-title font-weight-600">Average Monthly Collection Effeciency</h3>
                ...
                <div class="col-lg-3  ">
                    ...
                    <div class="panel panel-default  card shadow light">
                        <div class="panel-heading">
                            <h3 class="panel-title font-weight-600">Waste Collection Overview</h3>
                    ...
                    <div class="panel panel-default card light  margin-bottom-10">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="chartbox">
                                ...
                                <script>
                                    var simple_line_chart3;
                                    $(document).ready(function ($) {
                                        (function () {
                                            simple_line_chart3 = c3.generate({
                                                bindto: '#chart-hours1',
                                                size: {
                                                    height: 180,
                                                },
