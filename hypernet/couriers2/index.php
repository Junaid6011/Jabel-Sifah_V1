...
<div class="row">
          ...
          <div class="shadow">
            <div class="widget-content  bg-red-700 height-200  white relative  margin-bottom-30 padding-0 " style="overflow:hidden;">
              ...
              <div class="padding-left-20 padding-right-20 padding-top-20">
                <div class="row x">
                  <div class="col-xs-6">
                    <div>Consignment Delivered</div>
                    <div class="font-size-40 text-nowrap "> <span class="statistic-counter">1452  </span> </div>

                    <div class="">12% more than last yesterday</div>
                  </div>
                  <div class="col-xs-6 text-right">
                    <div>Value of Consignment Delivered</div>
                    <div class="font-size-26 text-nowrap"> 1800 $ </div>
                    <div class="font-size-10"><i class="ion-arrow-graph-up-right"></i> 07% lower than estimated</div>
                  ...
                  $(document).ready(function ($) {
                    (function () {
                      var simple_line_chart = c3.generate({
                        ...
                        data: {
                          columns: [
                              ['Reviews (Points)', 130, 140, 170, 160, 180, 150, 180],
                          ],
                          type: 'line',
                        },
                        color: {
        ...
        <div class="col-lg-2">
          <div class="">
            ...
            <div class="widget-content padding-10 bg-cyan-700 height-200 text-center relative shadow">
              <div class="white margin-top-10">
                <div class="counter-number-group">
                  <div class=" font-size-14 margin-bottom-10"> Consignments Recieved</div>

                  <div class="">
                    <i> <img src="images/icon-parcel-delievered.png" alt="img" height="40" class=""> </i>
                  </div>
                  <span class="font-size-30">650</span>

                </div>
                <span class="label white absolute bg-cyan-600  flat right bottom">
                  Today
                </span>
		 ...
		 <div class="col-lg-5 ">
            ...
            <ul class="nav nav-tabs nav-tabs-solid " data-plugin="nav-tabs" role="tablist">
              <li class="active"><a data-toggle="tab" href="#exampleTabsLineLeftOne" role="tab" aria-expanded="true">Consignment Returned</a></li>
              <li class=""><a data-toggle="tab" href="#exampleTabsLineLeftTwo" a="" role="tab" aria-expanded="false">Consignment Delivered</a></li>
                        ...
                        <div class="panel-body padding-15">
                            ...
                            <div class="chartbox">
                                    ...
                                    $(document).ready(function ($) {
                                        (function () {
                                            simple_line_chart = c3.generate({
                                                ...
                                                data: {
                                                    columns: [
                                                        ['Consignments Recieved', 95, 90, 50, 70, 85, 65, 92],
                                                        ['Consignments Dispatched', 75, 90, 55, 80, 63, 72,39],
														['Consignments Pending', 33, 12, 40, 65, 56, 87,43],
                                                    ],
                                                    type: 'area',
                                                },
                                                // subchart: {
                                ...
                                $("#waq-class1").on('change', function () {
                                 ...
                                 unload: true,
                                 columns: [
                                                        ['Consignments Recieved', 195, 190, 150, 170, 185, 165, 192],
                                                        ['Consignments Dispatched', 175, 190, 155, 180, 163, 172,139],
														['Consignments Pending', 133, 112, 140, 165, 156, 187,143],
                                                    ],
                      });
                    }
                  });
