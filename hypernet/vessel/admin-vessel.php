                    ...
                    <div class="row">
                        <div class="col-lg-9">
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-icon">
                                            <select class="form-control selectpicker " data-width="100%" data-size="5"
                                                ...
                                                <option data-subtext="" selected> Bulk Carrier </option>
                                                <option data-subtext=""> Tugs & barges 10k Tons </option>
                                                <option data-subtext=""> Tugs & barges 7k Tons+ 5k tons </option>
                                                <option data-subtext="">Tugs & barges 7k Tons </option>
                                                <option data-subtext=""> Construction Vessels </option>
                                                <option data-subtext=""> Speed boats </option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label class="control-label">DWT Capacity</label>
                                        <input type="text" class="form-control" placeholder="..." />
                                    </div>
                                </div>
                                <div class="col-sm-4">
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="padding-15 padding-bottom-0 text-center">
                                ...
                                <div class="margin-bottom-10 ">
                                    <img src="images/vesse-photo1.jpg " class=" img-bordered  "
                            ...
                            <table
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-left"> Tugs & barges 10k  </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-left"> Speed boats </td>
