                                ...
                                <div class="col-lg-5">
                                    ...
                                    <div class="margin-bottom-10 clearfix text-center">
                                        <div class="form-group1">
                                            <div class="inline-block">
                                                <select class="form-control input-sm" id="mrq-dd-Completion2">
                                    ...
                                    <div class="chartbox">
                                        ...
                                        <script>
                                            ...
                                            var simple_line_chart5;
                                            $(document).ready(function ($) {
                                                (function () {
                                                    simple_line_chart5 = c3.generate({
                                                        bindto: '#chart-hours',
                                                        size: {
                                                            height: 260,
                                                        },
                                    ...
                                    <script>
                                        ...
                                        $("#mrq-dd-Completion2").on('change', function () {

                                            if (this.value.trim().toLowerCase().includes('month')) {
                                                simple_line_chart5.load({
                                                    unload: true,
                                                    columns: [
                                                        ['Numbers', 152, 50, 95, 15,],
                                                    ],
