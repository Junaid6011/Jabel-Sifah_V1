        ...
        <!-- <div class="page-header page-header-bordered shadow">
            ...
            <div class="media">
                <div class="media-left">
                    <img src="images/vessel-customer1.png" class="img-bordered" style="height:55px">
                </div>
                <div class="media-body">
                    <h3 class="media-heading font-size-20">LUSAIL PALACE - EASTERN VIEW</h3>
                    <div> <b>Customer: </b> <a href="customer.php"> GEMCO</a> </div>
                </div>
            </div>
            ...
            <div class="page-header-actions">
                ...
                <a href="project.php" class="btn btn-sm btn-info  "> View Details</a>
    ...
    <h3 class="panel-title font-weight-600">Task Completion Statistics</h3>
                        ...
                        <div class="panel-body padding-15">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class=" font-size-20 margin-bottom-10 margin-top-0 text-center"> Job
                                        Completion
                                        Statistics </div>
                                    <div class="margin-bottom-10 clearfix text-center">
                                        <div class="form-group1">
                                            <div class="inline-block">
                                                <select class="form-control input-sm" id="mrq-dd-Job">
                                    ...
                                    <div class="chartbox" class="">
                                        ...
                                        <script>      var simple_line_Job;
                                            $(document).ready(function ($) {

                                                (function () {
                                                    simple_line_Job = c3.generate({
                                                        bindto: '#chart-fff',
                                                        size: {
                                                            height: 285,
                                                        },
                                                        ...
                                                        data: {
                                                            columns: [
                                                                ['Tasks', 830, 420, 550, 540, 660],
                                                                ['Completed', 300, 200, 160, 400, 250],
                                                                ['Pending', 200, 130, 90, 240, 130],
                                                                ['Inprogess', 130, 120, 150, 140, 160],
                                        ...
                                        <script>
                                            ...
                                            $("#mrq-dd-Job").on('change', function () {

                                                if (this.value.trim().toLowerCase().includes('month')) {
                                                    simple_line_Job.load({
                                                        unload: true,
                                                        columns: [
                                                            ['Tasks', 830, 420, 550, 540, 660],
                                                            ['Completed', 300, 200, 160, 400, 250],
                                                    ...
                                                    simple_line_Job.load({
                                                        unload: true,
                                                        columns: [
                                                            ['Tasks', 1830, 1420, 1550, 1540, 1660],
                                                            ['Completed', 1300, 1200, 1160, 1400, 1250],
                                                            ['Pending', 1200, 1130, 190, 1240, 1130],
                                                            ['Inprogess', 1130, 1120, 1150, 1140, 1160],
                                                        ],
                                                    });
                                                }
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default  padding-0  card1 shadow light" style="min-height: 200px;">
                                        ...
                                        <div class="panel-body padding-15  ">
                                            <div class="margin-bottom-20 p clearfix"
                                                ...
                                                <!-- <div class="inline-block pull-left margin-right-10"
                                                    ...
                                                    <select class=" form-control input-sm  selectpicker picker1 mrq-dd"
                                                        multiple data-live-search="true" data-mrq-col-no="0"
                                                        data-mrq-table-id="table">
                                                        <option selected>All</option>
                                                        <option>JOB189 </option>
                                                        <option>JOB124</option>
                                                        <option>JOB127</option>
                                                        <option>JOB141 </option>
                                                        <option>JOB151</option>
                                                        <option>JOB161</option>
                                                    </select>
                                                </div> -->
                                            ...
                                            <div class="table-responsive">
                                                <table
                                                    class="table  margin-bottom-0 table-hover table-condensed table-bordered  tablesorter "
                                                    id="table">
                                                    <thead>
                                                        <tr class="">
                                                            <th class="text-left" width="100">Job</th>
                                                            <th class="text-left" width="120">Vessel </th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-left">
                                                                <div class="media" style="width: 200px;">
                                                                    ...
                                                                    <div class="media-body">
                                                                        <a href="vessel.php"
                                                                            class="font-weight-600">EASTERN VIEW
                                                        ...
                                                        <tr>
                                                            <td class="text-left"> <a href="job.php">JOB124</a>
                                                            </td>
                                                            <td class="text-left">
                                                                <div class="media" style="width: 200px;">
                                                                    <div class="media-left padding-right-10">
                                                                    ...
                                                                    <div class="media-body">
                                                                        <a href="vessel.php"
                                                                            class="font-weight-600">Polaris XX (ex Sea
                                                                            Canis)


                                                                        </a>
                                                                        <br>
                                                                        <i class="small">Tugs & barges 10k Tons
                                                                        </i>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <tr>
                                                            <td class="text-left"> <a href="job.php">JOB127</a>
                                                            </td>
                                                            <td class="text-left">
                                                                <div class="media" style="width: 200px;">
                                                                    <div class="media-left padding-right-10">
                                                        ...
                                                        <tr>
                                                            <td class="text-left"> <a href="job.php">JOB141</a>
                                                            </td>
                                                            <td class="text-left">
                                                                <div class="media" style="width: 200px;">
                                                                    <div class="media-left padding-right-10">
                                                                    ...
                                                                    <div class="media-body">
                                                                        <a href="vessel.php"
                                                                            class="font-weight-600">Octopus 194 (ex GTO
                                                                            194)


                                                                        </a>
                                                                        <br>
                                                                        <i class="small">Construction Vessels
                                                                        </i>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <tr>
                                                            <td class="text-left"> <a href="job.php">JOB151</a>
                                                            </td>
                                                            <td class="text-left">
                                                                <div class="media" style="width: 200px;">
                                                                    <div class="media-left padding-right-10">
                                                        ...
                                                        <tr>
                                                            <td class="text-left"> <a href="job.php">JOB161</a>
                                                            </td>
                                                            <td class="text-left">
                                                                <div class="media" style="width: 200px;">
                                                                    <div class="media-left padding-right-10">
                                                                    ...
                                                                    <div class="media-body">
                                                                        <a href="vessel.php" class="font-weight-600">Sea
                                                                            Challenger (ex UCC TGB 22)
                                        ...
                                        <div class="panel-body padding-15  ">
                                            <div class="margin-bottom-20 p clearfix"
                                                ...
                                                <!-- <div class="inline-block pull-left margin-right-10"
                                                    ...
                                                    <select class=" form-control input-sm  selectpicker picker1 mrq-dd"
                                                        multiple data-live-search="true" data-mrq-col-no="0"
                                                        data-mrq-table-id="table2">
                                                        <option selected>All</option>
                                                        <option>JOB221 </option>
                                                        <option>JOB389</option>
                                                        <option>JOB130</option>
                                                        <option>JOB110 </option>
                                                        <option>JOB124</option>
                                                        <option>JOB235</option>
                                                    </select>
                                                </div> -->
                                                <div class="inline-block pull-left   margin-bottom-10 margin-right-10">
                                                    <div class="">
                                            ...
                                            <div class="table-responsive">
                                                <table
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <!-------->
                                                        <tr>
                                                            <td class="text-left"> <a href="job.php">JOB221</a>
                                                            </td>
                                                            <td class="text-left">
                                                                <div class="media" style="width: 200px;">
                                                                    <div class="media-left padding-right-10">
                                                                    ...
                                                                    <div class="media-body">
                                                                        <a href="vessel.php"
                                                                            class="font-weight-600">Pluto B (ex UCO B)


                                                                        </a>
                                                                        <br>
                                                                        <i class="small">Tugs & barges 7k Tons+ 5k tons
                                                                        </i>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <tr>
                                                            <td class="text-left"> <a href="job.php">JOB389</a>
                                                            </td>
                                                            <td class="text-left">
                                                                <div class="media" style="width: 200px;">
                                                                    <div class="media-left padding-right-10">
                                                        ...
                                                        <tr>
                                                            <td class="text-left"> <a href="job.php">JOB130</a>
                                                            </td>
                                                            <td class="text-left">
                                                                <div class="media" style="width: 200px;">
                                                                    <div class="media-left padding-right-10">
                                                        ...
                                                        <tr>
                                                            <td class="text-left"> <a href="job.php">JOB110</a>
                                                            </td>
                                                            <td class="text-left">
                                                                <div class="media" style="width: 200px;">
                                                                    <div class="media-left padding-right-10">
                                                                    ...
                                                                    <div class="media-body">
                                                                        <a href="vessel.php"
                                                                            class="font-weight-600">Marine Master 11 (ex
                                                                            UCC 11)


                                                                        </a>
                                                                        <br>
                                                                        <i class="small">Speed boats
                                                                        </i>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-left">
                                                                <div class="media" style="width: 200px;">
                                                                    ...
                                                                    <div class="media-body">
                                                                        <a href="vessel.php"
                                                                            class="font-weight-600">Express Evia 1
                                                        ...
                                                        <tr>
                                                            <td class="text-left"> <a href="job.php">JOB235</a>
                                                            </td>
                                                            <td class="text-left">
                                                                <div class="media" style="width: 200px;">
                                                                    <div class="media-left padding-right-10">
                                            ...
                                            <div class="table-responsive">
                                                <table
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td class="text-left"> <a href="job.php">JOB239</a>
                                                            </td>
                                                            <td class="text-left">
                                                                <div class="media" style="width: 200px;">
                                                                    <div class="media-left padding-right-10">
                                                                    ...
                                                                    <div class="media-body">
                                                                        <a href="vessel.php"
                                                                            class="font-weight-600">Pollux XX (ex Sea
                                                                            Cosmos)
                                                        ...
                                                        <tr>
                                                            <td class="text-left"> <a href="job.php">JOB112</a>
                                                            </td>
                                                            <td class="text-left">
                                                                <div class="media" style="width: 200px;">
                                                                    <div class="media-left padding-right-10">
                                                        ...
                                                        <tr>
                                                            <td class="text-left"> <a href="job.php">JOB118</a>
                                                            </td>
                                                            <td class="text-left">
                                                                <div class="media" style="width: 200px;">
                                                                    <div class="media-left padding-right-10">
                                                                    ...
                                                                    <div class="media-body">
                                                                        <a href="vessel.php"
                                                                            class="font-weight-600">Pluto D (ex UCO D)


                                                                        </a>
                                                                        <br>
                                                                        <i class="small">Tugs & barges 7k Tons+ 5k
                                                                            tons</i>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <tr>
                                                            <td class="text-left"> <a href="job.php">JOB289</a>
                                                            </td>
                                                            <td class="text-left">
                                                                <div class="media" style="width: 200px;">
                                                                    <div class="media-left padding-right-10">
                                                                    ...
                                                                    <div class="media-body">
                                                                        <a href="vessel.php"
                                                                            class="font-weight-600">Marine Master 2 (ex
                                                                            UCC 2)
                                                        ...
                                                        <tr>
                                                            <td class="text-left"> <a href="job.php">JOB132</a>
                                                            </td>
                                                            <td class="text-left">
                                                                <div class="media" style="width: 200px;">
                                                                    <div class="media-left padding-right-10">
                                                                    ...
                                                                    <div class="media-body">
                                                                        <a href="vessel.php"
                                                                            class="font-weight-600">Marine Master 4 (ex
                                                                            UCC 4)
                                                        ...
                                                        <tr>
                                                            <td class="text-left"> <a href="job.php">JOB153</a>
                                                            </td>
                                                            <td class="text-left">
                                                                <div class="media" style="width: 200px;">
                                                                    <div class="media-left padding-right-10">
                                                                    ...
                                                                    <div class="media-body">
                                                                        <a href="vessel.php"
                                                                            class="font-weight-600">Sirius X (ex Uranus)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-left">
                                                                <div class="media" style="width: 200px;">
                                                                    ...
                                                                    <div class="media-body">
                                                                        <a href="vessel.php"
                                                                            class="font-weight-600">Phoenix XX (ex Sea
                                                                            Centaurus)
