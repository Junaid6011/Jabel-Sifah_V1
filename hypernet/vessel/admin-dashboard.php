        ...
        <div class="page-content  ">
            ...
            <div class="padding-0">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <a href="admin-vessel.php" class="grey-700">
                            <div class="padding-15 bg-primary-100 text-center card  margin-bottom-30">
                                ...
                                <span class=" font-weight-600 text-uppercase ">Vessels </span>
                            </div>
                        </a>
                    </div>

                    <div class="col-md-3">
                        <a href="admin-job.php" class="grey-700">
                            <div class="padding-15 bg-primary-100 text-center card  margin-bottom-30">
                                <div class="margin-bottom-10    primary-800">
                    ...
                    <div class="col-md-3">
                        <a href="admin-project.php" class="grey-700">
                            <div class="padding-15 bg-primary-100 text-center card hover margin-bottom-30">
                                <div class="margin-bottom-10    primary-800">
                                    <img src="images/icon_leftmenu_employees.png" alt="img" width="20">
                                </div>
                                <span class=" font-weight-600 text-uppercase ">Projects</span>
                            </div>
                        </a>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <a href="admin-port.php" class="grey-700">
                            <div class="padding-15 bg-primary-100 text-center card  margin-bottom-30">
                                ...
                                <span class=" font-weight-600 text-uppercase ">Ports</span>
                            </div>
                        </a>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <a href="admin-material.php" class="grey-700">
                            <div class="padding-15 bg-primary-100 text-center card  margin-bottom-30">
                                <div class="margin-bottom-10    primary-800">
                                    <img src="images/icon_leftmenu_maintenances.png" alt="img" width="20">
                                </div>
                                <span class=" font-weight-600 text-uppercase ">Material</span>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-md-3">
                        <a href="admin-barges.php" class="grey-700">
                            <div class="padding-15 bg-primary-100 text-center card  margin-bottom-30">
                                <div class="margin-bottom-10    primary-800">
                                    <img src="images/icon_leftmenu_territorirs.png" alt="img" width="20">
                                </div>
                                <span class=" font-weight-600 text-uppercase ">Bargers</span>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-md-3">
                        <a href="admin-tugs.php" class="grey-700">
                            <div class="padding-15 bg-primary-100 text-center card  margin-bottom-30">
                                <div class="margin-bottom-10    primary-800">
                                    <img src="images/icon_leftmenu_jobs.png" alt="img" width="20">
                                </div>
                                <span class=" font-weight-600 text-uppercase ">Tugs</span>
                            </div>
                        </a>
                    </div>
                    ...
                    <!-- <div class="col-md-3 col-md-offset-4">
                        <a href="" class="grey-700">
                            <div class="padding-15 bg-primary-100 text-center card  margin-bottom-30">
                                ...
                                <span class=" font-weight-600 text-uppercase ">Fuel Rates</span>
                            </div>
                        </a>
                    </div> -->
                </div>
