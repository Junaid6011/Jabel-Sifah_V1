                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-icon">
                                                <select class="form-control selectpicker " data-width="100%" data-size="5" data-style="btn-select">
                                                    <option data-subtext=""> Loading </option>
                                                    <option data-subtext=""> Discharging </option>
                                                    <option data-subtext=""> Both </option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="margin-bottom-10 ">
                                        <div class="mapbox margin-bottom-0 ">
                                            <iframe
                                                ...
                                                width="100%" height="210" frameborder="0" style="border:0" class="pull-left map"></iframe>
