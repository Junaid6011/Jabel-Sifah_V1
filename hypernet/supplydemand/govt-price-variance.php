            ...
            <div class=" page-content container-fluid">
                  ...
                  <div class="col-lg-12">
                     <div class="panel panel-default  card light ">
                        <div class="panel-heading margin-bottom-0">
                           <h3 class="panel-title font-weight-600 ">Cost Purchase Price Variances</h3>
                        </div>
                        <div class="panel-body padding-20">
                           ...
                           <div class="row">
                                       ...
                                       $(document).ready(function ($) {
                                          (function () {
                                             ...
                                             var chart = c3.generate({
                                                ...
                                                data: {
                                                   columns: [
                                                      ['Actual Price', 30, 200, 200, 400, 150],
                                                      ['Purchase Price', 130, 100, 100, 200, 150],
                                                      ['Sold Price', 230, 200, 200, 300, 250]
                                                   ],
                                                   type: 'bar',
                                                   groups: [
                                                      ['Supply', 'Demand']
                                                ...
                                                axis: {
                                                   ...
                                                   x: {
                                                      ...
                                                      type: 'category',
                                                      categories: ['Direct Import', 'Finished Goods', 'Raw Material', 'Builder Hardware', 'Direct Import']
                                                   },
                                                   y: {
                                                      label: {
                                                         text: '% ',
                              ...
                              <div class="col-lg-2">
                                 <div class="widget  margin-bottom-1 ">
                                    <div class="widget-content padding-15 bg-teal-100   ">
                                       <div class=" text-center padding-top-0">
                                          <div class="counter-number-group">
                                             <div class="">
                                                <div class="text-uppercase font-size-16 margin-bottom-30"><b>Ovellall Price Ratio</b></div>
                                                <!-- <div class="dropdown margin-bottom-20 " style="padding-top: 5px;">
                                                      <select type="button" class="btn bg-green-800 btn-block1 white dropdown-toggle btn-xs text-center " data-toggle="dropdown" id="mrq-dd-cowchange">
                                                         This Month
                                                ...
                                                <div class="margin-bottom-10">
                                                   <i> <img src="images/icon_leftmenu_jobs.png" alt="img" height="80" class=""> </i>
                                                </div>
                                                <span class="font-size-30 margin-bottom-20" id="cow1">9.77 %</span>
                                       ...
                                       $(document).ready(function ($) {
                                          (function () {
                                             ...
                                             var chart = c3.generate({
                                                ...
                                                data: {
                                                   columns: [
                                                      ['Price Variance', 30, 200, 200, 400, 150, 30, 200, 200, 400, 150, 30, 200],
                                                      // ['Purchase Price', 130, 100, 100, 200, 150],
                                                      // ['Sold Price', 230, 200, 200, 300, 250]
                                                   ],
                                                   type: 'area',
               ...
               <div class="row">
                  <div class="col-lg-12">
                     <div class="panel panel-default  card light ">
                        <div class="panel-heading margin-bottom-0">
                           <h3 class="panel-title font-weight-600 ">Optimize Purchase </h3>
                        </div>
                        <div class="panel-body padding-20">
                                       ...
                                       var chart = c3.generate({
                                          ...
                                          data: {
                                             columns: [
                                                ...
                                                ['Aircraft Parts', 25, 22, 19, 13, 10, 14, 13, 22, 19, 13, 20, 280],
                                                ['Air Conditioners', 125, 222, 119, 313, 110, 214, 213, 221, 195, 103, 220, 180],
                                                ['Cement', 65, 22, 19, 13, 10, 14, 13, 22, 19, 13, 20, 280],
