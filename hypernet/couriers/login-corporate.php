...
<body class="dashboard " style="background-image: url(images/bg-login.jpg);  background-size:100%; padding:0; ">

<div class="page-header1 ">
  

            <div class="page-header-actions" style="left:20px">
    ...
    <div class="loginbox card" style="height:410px;">
        <div class="back">
        ...
        <div class="front shadow">
            <div class="login padding-20 text-center">
                ...
                <h4 class="font-weight-600 text-uppercase green-800 margin-top-10 margin-bottom-30">Corporate Customer</h4>
        

                <?php include("_form-corporate.php") ?>
            </div>
