                                    ...
                                    <div class="padding-15 bg-cyan-700 " style="height:220px;">
                                        <div class="text-center padding-top-0">
                                            <div class="">
                                                ...
                                                <img src="images/user.jpg" id="mrq-m3" alt="img" style="height:80px;" class="img-circle1 img-bordered img-bordered-primary">



                                                <div>
                                                    <a href="" data-toggle="popover" data-original-title="" data-trigger="hover" data-container="body" data-placement="bottom" data-html="true" id="name1" class="white">
                                                        <div class="font-size-16  margin-bottom-5 font-weight-600" id="mrq-m1">
                                                            Luis Suarez</div>
                                                    </a>
                                                ...
                                                <div class="margin-bottom-5 stars  ">
                                                    ...
                                                    <button id="rating4" type="button" class="btn btn-warning btn-grey btn-xs">
                                                        <span class="glyphicon glyphicon-star"></span>
                                                    </button>
                                                    <button id="rating5" type="button" class="btn btn-default btn-grey btn-xs">
                                                        <span class="glyphicon glyphicon-star"></span>
                                                    </button>
                                                </div>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td class="text-center" width="80">
                                                                <div class="margin-right-20 bg-green-100 padding-0 font-size-30 green-800">
                                                                    <img src="images/icon-taskrate.png" alt="img" height="40" class="inline">
                                                                </div>
                                                            </td>
                                                            <td width="">
                                                            ...
                                                            <td class="text-center">
                                                                <div class="margin-top-0 bg-white padding-5 font-size-30 green-800">
                                                        ...
                                                        <tr>
                                                            <td class="text-center">
                                                                <div class="margin-right-20 bg-green-100 padding-0 font-size-30 orange-800">
                                                                    <img src="images/icon-hire.png" alt="img" height="40" class="inline">
                                                                </div>
                                                            </td>
                                                            <td width="">
                                                        ...
                                                        <tr>
                                                            <td class="text-center">
                                                                <div class="margin-right-20 bg-green-100 padding-0 font-size-30 orange-800">
                                                                    <img src="images/icon-turnover.png" alt="img" height="40" class="inline">
                                                                </div>
                                                            </td>
                                                            <td width="">
                                                        ...
                                                        <tr>
                                                            <td class="text-center">
                                                                <div class="margin-right-20 bg-green-100 padding-0 font-size-30 orange-800">
                                                                    <img src="images/icon-leave.png" alt="img" height="40" class="inline">
                                                                </div>
                                                            </td>
                                                            <td width="">
                                                                <div class="font-size-24 orange-800 font-weight-600 "> 07
                                                    ...
                                                    <div class="panel-group left-filters" id="AccordionFilters1">
                                                        ...
                                                        <div class="panel">
                                                            ...
                                                            <div class="panel-collapse collapse in" id="Types" role="tabpanel">
                                                                <div class="panel-body padding-0">
                                                                    <ul class="list-group list-group-bordered mrq-cb" data-mrq-col-no="5" data-mrq-table-id="table">
                                                                        <li class="list-group-item">
                                                                            <span class="badge badge-default">100</span>
                                                                            <div class="inline-block ">
                                                                                <div class="checkbox-custom checkbox-info margin-0 ">
                                                                                    <input type="checkbox" id="Hook" value="Technical">
                                                                        ...
                                                                        <li class="list-group-item">
                                                                            ...
                                                                            <div class="inline-block ">
                                                                                <div class="checkbox-custom checkbox-info margin-0 ">
                                                                                    <input type="checkbox" id="Compactor" value="Staff">
                                                                                    <label for="Compactor">Staff</label>
                                                                                </div>
                                                                            </div>
                                                                        </li>
                                                                        <li class="list-group-item">
                                                                            ...
                                                                            <div class="inline-block ">
                                                                                <div class="checkbox-custom checkbox-info margin-0 ">
                                                                                    <input type="checkbox" id="Chain" value="Manager">
                                                                                    <label for="Chain">Manager</label>
                                                                                </div>
                                                                            </div>
                                                                        </li>
                                                                        ...
                                                                        <li class="list-group-item">
                                                                            ...
                                                                            <div class="inline-block ">
                                                                                <div class="checkbox-custom checkbox-info margin-0 ">
                                                                                    <input type="checkbox" id="Chain" value="Rider">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="vscroll padding-right-0" style="height:auto;">
                                                    <table class="table  table-bordered table-condensed1 table-striped1 margin-bottom-0" id="table">
                                                        <thead>
                                                            <tr class="">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="employee.php" class="font-weight-600">Joe
                                                                                Denly
                                                                            </a>
                                                                            <br>
                                                                ...
                                                                <td class="text-left hidden">Staff
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="employee.php" class="font-weight-600">Ivar
                                                                                Banega
                                                                            </a>
                                                                            <br>
                                                            ...
                                                            <tr>
                                                                <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="employee.php" class="font-weight-600">Philippe
                                                                                Coutinho
                                                                            </a>
                                                                            <br>
                                                                ...
                                                                <td class="text-left">
                                                                    <div class="margin-bottom-0  stars small">
                                                                        ...
                                                                        <button type="button" class="btn btn-grey btn-grey btn-xs">
                                                                            <span class="glyphicon glyphicon-star"></span>
                                                                        </button>
                                                                        <button type="button" class="btn btn-default btn-grey btn-xs">
                                                                            <span class="glyphicon glyphicon-star"></span>
                                                            ...
                                                            <tr>
                                                                <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="employee.php" class="font-weight-600">Luis
                                                                                Suarez
                                                                            </a>
                                                                            <br>
                                                                            <i class="small">Technical</i>
                                                            ...
                                                            <tr>
                                                                <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="employee.php" class="font-weight-600">Aurthr
                                                                                Vidal
                                                                            </a>
                                                                            <br>
                                                                            <i class="small">Rider</i>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <td class="text-left">
                                                                    <div class="margin-bottom-0  stars small">
                                                                        ...
                                                                        <button type="button" class="btn btn-wgreyarning btn-xs">
                                                                            <span class="glyphicon glyphicon-star"></span>
                                                                        </button>
                                                                        <button type="button" class="btn btn-grey btn-xs">
                                                                            <span class="glyphicon glyphicon-star"></span>
                                                                ...
                                                                <td class="text-left hidden">Rider
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="employee.php" class="font-weight-600">John
                                                                                Dynamo
                                                                            </a>
                                                                            <br>
                                                                            <i class="small">Technical</i>
                                                            ...
                                                            <tr>
                                                                <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="employee.php" class="font-weight-600">Neymar
                                                                                Jr.
                                                                            </a>
                                                                            <br>
                                                                            <i class="small">Technical</i>
                                                ...
                                                <nav>
                                                    <ul class="pagination pagination-sm ">
                                                        <li class="pagination-prev disabled"><a href="javascript:void(0)"><span class="icon ion-android-arrow-back"></span></a></li>
                                                        ...
                                                        <li class="pagination-next"><a href="javascript:void(0)"><span class="icon ion-android-arrow-forward"></span></a></li>
                                                    </ul>
                                                </nav>
