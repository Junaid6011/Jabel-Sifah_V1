                        ...
                        <div class="bg-white padding-30">
                            ...
                            <div class="pearls pearls-sm  row">
                                <div class="pearl done  col-xs-3">
                                    <div class="pearl-icon bg-blue-800"><i class="ion-bag"></i></div>
                                    <span class="pearl-title  ">Ordered</span>
                                </div>
                                <div class="pearl  done  col-xs-3">
                                    <div class="pearl-icon bg-blue-800"><i class="ion-pricetags"></i></div>
                                    <span class="pearl-title  ">Pre Shippment</span>
                                </div>
                                <div class="pearl current error col-xs-3">
                                    <div class="pearl-icon "><i class="ion-navigate"></i></div>
                                    <span class="pearl-title  ">Shipped/In Transit</span>
                                </div>
                                <div class="pearl disabled col-xs-3">
                                    <div class="pearl-icon "><i class="ion-checkmark"></i></div>
                                    <span class="pearl-title ">Delivered</span>
                                </div>
                            </div>
                            <hr />
                            ...
                            <div class="font-size-18 text-center1 margin-bottom-10 grey-800">Tracking Details</div>
