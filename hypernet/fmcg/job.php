                    ...
                    <div class="panel panel-default  padding-0  card shadow light " style="min-height: 200px;">
					 ...
					 <div class="col-lg-2">
                      <div class="widget   shadow ">
                          <div class="widget-content  padding-15 bg-red-700 " style="height:255px;">
                              <div class="counter counter-md counter-inverse text-center padding-top-10">
                                  <div class="counter-number-group">
                                      <div class="text-uppercase font-size-14 margin-top-5"> <b> Total Consignments  </b></div>

                                      <div class="" >
                                          <i> <img src="images/icon-parcel-delievered.png" alt="img" height="40" class=""> </i>
                                      </div>
                                      <span class="font-size-30">160</span>

                                  </div>
                                  <div class="row no-space bottom bg-red-800 padding-top-20 padding-bottom-10 ">
                                      <div class="col-xs-6"  style="border-right:1px solid #999;">
                                          <div class="counter ">
                                              <div class="counter-label ">Delivered</div>
                                      ...
                                      <div class="col-xs-6">
                                          <div class="counter ">
                                              <div class="counter-label ">Returned</div>
                                              <div class="font-size-18">
                                              30
                                              </div>
                                          </div>
                                                  ...
                                                  <table class="table  table-condensed  no-border  margin-bottom-0">
                                                      <tbody>
                                                        ...
                                                        <tr>
                                                          ...
                                                          <tr>
                                                              <th width=""> <b>Volume Consumed</b>  </th>
                                                              <td class="text-left">
                                                                  160
                                                          ...
                                                          <tr>
                                                              <th width=""> <b> Trip Type </b>  </th>
                                                              <td class="text-left">
                                                                 <b> Secondary Dispatch <span class="pull-right"><span class="label   label-info">In Progress</span></span> </b>
                                                          ...
                                                          <tr>
                                                              ...
                                                              <td class="text-left">
                                                                  Drop Consignments at drop-off locations.</span>
