                                        ...
                                        <div class="text-center padding-top-0">
                                            <div class="">
                                                ...
                                                <div class="dropdown margin-bottom-20 ">
                                                    <select type="button" class="btn bg-teal-800 btn-block1 white dropdown-toggle btn-xs text-center " data-toggle="dropdown" id="mrq-dd-Most">
                                                        This Month
                                                ...
                                                <div class="font-size-14 margin-bottom-10" id="mrq-v2"> 2530 Products </div>
...
-->
                                                    <span class="" id="mrq-v4">13% more than last Month</span>
                                                </div>
                                                <script>
                                                    $("#mrq-dd-Most").on('change', function () {
                                                        if (this.value.trim().toLowerCase().includes('month')) {
                                                            $("#mrq-v1").text('	Warehouse 3')
                                                            $("#mrq-v2").text('2530 Products')
                                                            //                                                        $("#mrq-v3").text('17%')
                                                            $("#mrq-v4").text('13% more than last month')
                                                        } else {
                                                            $("#mrq-v1").text('	Warehouse 1')
                                                            $("#mrq-v2").text('27820 Products')
                                                            //                                                        $("#mrq-v3").text('17%')
                                                            $("#mrq-v4").text('20% more than last year')
                                                        }
                                                    })
                                                </script>
                                            </div>
                                    ...
                                    <div class="padding-15 bg-teal-700 " style="height:220px;">
                                        <div class="text-center padding-top-0">
                                            <div class="">
                                                ...
                                                <div class="dropdown margin-bottom-20 ">
                                                    <select type="button" class="btn bg-teal-800 btn-block1 white dropdown-toggle btn-xs text-center " data-toggle="dropdown" id="mrq-dd-Least">
                                                        This Month
                                                        <span class="caret"></span>
                                                ...
                                                <div class="font-size-14 margin-bottom-10" id="mrq-vv2">1780 Products</div>
                                                <div class="font-size-10">
                                                    <!--
                                                <span class="margin-right-5"><i
                                                        class="ion-arrow-graph-up-right"></i></span>
                                                <span class="" id="mrq-v3">13%</span>
-->
                                                    <span class="" id="mrq-w4">17% more than month</span>
                                                </div>
                                                <script>
                                                    $("#mrq-dd-Least").on('change', function () {
                                                        if (this.value.trim().toLowerCase().includes('month')) {
                                                            $("#mrq-w1").text('	Warehouse 2')
                                                            $("#mrq-vv2").text('1780 Products')
                                                            //                                                        $("#mrq-v3").text('17%')
                                                            $("#mrq-w4").text('17% more than last month')
                                                        } else {
                                                            $("#mrq-w1").text('	Warehouse 4')
                                                            $("#mrq-vv2").text('11780 Products')
                                                            //                                                        $("#mrq-v3").text('17%')
                                                            $("#mrq-w4").text('19% more than last year')
                                                        }
                                                    })
                                                </script>
                                            </div>
                                                                        ...
                                                                        <li class="list-group-item">
                                                                            ...
                                                                            <div class="inline-block ">
                                                                                <div class="checkbox-custom checkbox-info margin-0 ">
                                                                                    ...
                                                                                    <label for="Online4">Blood Bank</label>
                                                                                </div>
                                                                            </div>
                                                                        </li>
                                                                    </ul>
                                                    ...
                                                    <div class="hidden_fields_one">
                                                        ...
                                                        <span class="icon" style="left:20%; top:57%;">
                                                            <a data-toggle="popover" data-original-title="RAAR160" data-trigger="hover" data-container="body" data-placement="top" data-html="true" href="#" id="start2">
                                                                <img src="images/icon-map-warehouse-blood.png" alt="img" height="50">
                                                            </a>
                                                        </span>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <div class="padding-15 bg-cyan-1001 margin-bottom-0">
                                            ...
                                            <div class="font-size-16 text-center margin-bottom-10"> Useage Statistics</div>
                                                        ...
                                                        <tbody>
                                                                ...
                                                                <td class="text-left">
                                                                    <div class="media" style="max-width: 150px;">
                                                                        <div class="media-left padding-right-10">
                                                                            <img src="images/icon_warehouse.png" class="img-bordered" style="height:36px; width:36px">
                                                                        </div>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-left">
                                                                    <div class="media" style="max-width: 150px;">
                                                                        <div class="media-left padding-right-10">
                                                                            <img src="images/icon_warehouse1.png" class="img-bordered" style="height:36px; width:36px">
                                                                        </div>
                                                                        <div class="media-body">
                                                                            <a href="warehouse.php" class="font-weight-600">
                                                                                Warehouse 2 </a>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-left">
                                                                    <div class="media" style="max-width: 150px;">
                                                                        <div class="media-left padding-right-10">
                                                                            <img src="images/icon_warehouse3.png" class="img-bordered" style="height:36px">
                                                                        </div>
                                                                        <div class="media-body">
                                                                            <a href="warehouse.php" class="font-weight-600">
                                                                                Warehouse 3 </a>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-left">
                                                                    <div class="media" style="max-width: 150px;">
                                                                        <div class="media-left padding-right-10">
                                                                            <img src="images/icon_warehouse2.png" class="img-bordered" style="height:36px; width:36px">
                                                                        </div>
                                                                        <div class="media-body">
                                                                            <a href="warehouse.php" class="font-weight-600">
                                                                                Warehouse 53 </a>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-left">
                                                                    <div class="media" style="max-width: 150px;">
                                                                        <div class="media-left padding-right-10">
                                                                            <img src="images/icon_warehouse2.png" class="img-bordered" style="height:36px">
                                                                        </div>
                                                                        <div class="media-body">
                                                                            <a href="warehouse.php" class="font-weight-600">
                                                                                Warehouse 4 </a>
