            ...
            <!-- <div class="row">
                <div class="col-lg-4">
                    <div class="form-group margin-bottom-0">
                        ...
                        <select class="form-control selectpicker " data-width="100%" title="Location" data-style="btn-select"
                            ...
                            <div>
                                <div class="padding-15  text-center relative  card  hover     white">
                                    <div class="font-size-12 margin-bottom-10  text-uppercase  "
                                        onclick="window.location.href='assets-industry-it-servers.php'">
                                        Servers
                                            ...
                                            simple_line_Assets = c3.generate({
                                                ...
                                                axis: {
                                                    ...
                                                    x: {
                                                        ...
                                                        type: 'category',
                                                        categories: ['Computers', 'Laptops', 'Servers', 'Ghrapic Cards', 'Motherboards']
                                                    },
                                                    y: {
                                                        label: {
                    ...
                    <div class="panel panel-default  card shadow light">
                        ...
                        <div class="panel-body ">
                            <div class="margin-bottom-10 clearfix text-center">
                                <div class="form-group1">
                                    <div class="inline-block">
                                        <select class="form-control input-sm" id="mrq-dd-Stauts">
                                            <option>This Month </option>
                                            <option>This Year</option>
                                        </select>
                                    </div>
                            ...
                            <div class="chartbox">
                                ...
                                <script>
                                    var simple_line_Stauts;
                                    $(document).ready(function ($) {
                                        (function () {
                                            simple_line_Stauts = c3.generate({
                                                bindto: '#chart-rrr',
                                                size: {
                                                    height: 210,
                                                },
                                ...
                                <script>
                                    ...
                                    $("#mrq-dd-Stauts").on('change', function () {

                                        if (this.value.trim().toLowerCase().includes('month')) {
                                            simple_line_Stauts.load({
                                                unload: true,
                                                columns: [
                                                    ['In USe ', 25,],
                                                    ['Idle ', 75],
