            ...
            <div class="page-content  container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="panel panel-default  padding-0  card shadow light">
                            <div class="panel-heading font-weight-600 margin-bottom-0">
                                <ul class="nav nav-tabs nav-tabs-line" data-plugin="nav-tabs" role="tablist">
                                    <li class="active"><a data-toggle="tab" href="#Parking"> Tab 1</a></li>
                                    <li class=""><a data-toggle="tab" href="#Pickup"> Tab 2</a></li>
                                </ul>
                            </div>
