                    ...
                    <div class="col-md-3">
                        <a href="admin-employees.php" class="grey-700">
                            <div class="padding-15 bg-primary-100 text-center card hover margin-bottom-30">
                                ...
                                <span class=" font-weight-600 text-uppercase ">Assets</span>
                            </div>
                        </a>
                    </div>
                    <div class="col-md-3">
                        <a href="admin-jobs.php" class="grey-700">
                            <div class="padding-15 bg-primary-100 text-center card hover margin-bottom-30">
                                ...
                                <span class=" font-weight-600 text-uppercase">Fleets</span>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-md-3">
                        <a href="admin-customer.php" class="grey-700">
                            <div class="padding-15 bg-primary-100 text-center card hover margin-bottom-30">
                                ...
                                <span class=" font-weight-600 text-uppercase ">Customers / Contract</span>
                            </div>
                        </a>
                    </div>
                    <div class="col-md-3">
