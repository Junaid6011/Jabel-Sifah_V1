...
<body class="dashboard ">
                                ...
                                <div class=" padding-10 bg-orange-800 height-100 text-center relative ">
                                    <div class="white">
                                        ...
                                        <div class="">
                                            ...
                                            <b class="font-size-24" style="position:relative; top:5px;">700</b>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <table
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="">
                                                            <div class="font-size-24 red-800 font-weight-600 ">
                                                                14
                                                            </div>
                                                            <div class="font-size-12 font-weight-600">In
                                                                Operations
                                                            </div>
                                                            <div class="font-size-10 margin-top-0">
                                                                <span class="">20%</span>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="">
                                                            ...
                                                            <div class="font-size-12 font-weight-600"> Available
                                                                for
                                                                Jobs
                                                            </div>
                                                            <div class="font-size-10 margin-top-0">
                                                                ...
                                                                <ul class="list-group list-group-bordered mrq-cb"
                                                                    ...
                                                                    <li class="list-group-item">
                                                                        ...
                                                                        <div class="inline-block ">
                                                                            <div
                                                                                class="checkbox-custom checkbox-info margin-0 ">
                                                                                <input type="checkbox" id="Crew Cab"
                                                                                    name="" value="Crew Cab" />
                                                                                <label for="Crew Cab">Crew Cab</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                    ...
                                                    <table
                                                        ...
                                                        <thead>
                                                            <tr class="">
                                                                ...
                                                                <th class="text-left hidden">types</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-left hidden"> Trailer
                                                                </td>
                                                                <!--  <td class="text-center">
                                                                    <button type="button"
                                                                        class="btn btn-icon  btn-default btn-xs collapsed"
 ...
 -->
                                                            <tr>
                                                                ...
                                                                <td class="text-left hidden"> Crane
                                                                </td>
                                                                <!-- <td class="text-center">
                                                                    <button type="button"
                                                                        class="btn btn-icon  btn-default btn-xs collapsed"
...
-->
                                                            <tr>
                                                                ...
                                                                <td class="text-left hidden"> Chiller Truck
                                                                </td>
                                                                <!--     <td class="text-center">
                                                                    <button type="button"
                                                                        class="btn btn-icon  btn-default btn-xs collapsed"
...
-->
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-left hidden">Crew Cab
                                                                </td>
                                                                <!--   <td class="text-center">
                                                                    <button type="button"
                                                                        class="btn btn-icon  btn-default btn-xs collapsed"
