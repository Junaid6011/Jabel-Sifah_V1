                                ...
                                <div class=" padding-10 bg-orange-800 height-100 text-center relative ">
                                    <div class="white">
                                        ...
                                        <div class="">
                                            ...
                                            <b class="font-size-24" style="position:relative; top:5px;">2497</b>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-5">
                                    ...
                                    <div class="margin-bottom-10 clearfix text-center">
                                        <div class="form-group1">
                                            <div class="inline-block">
                                                <select class="form-control input-sm" id="mrq-dd-Center">
                                                    <option>This Month </option>
                                                    <option>This Year</option>
                                                </select>
                                            </div>
                                    ...
                                    <div class="chartbox">
                                        ...
                                        <script>
                                            var simple_line_Center;
                                            $(document).ready(function ($) {
                                                (function () {
                                                    simple_line_Center = c3.generate({
                                                        bindto: '#chart-hours',
                                                        size: {
                                                            height: 260,
                                                        },
                                        ...
                                        <script>
                                            ...
                                            $("#mrq-dd-Center").on('change', function () {

                                                if (this.value.trim().toLowerCase().includes('month')) {
                                                    simple_line_Center.load({
                                                        unload: true,
                                                        columns: [
                                                            ['Numbers', 200, 100, 100],
                                                        ],
                                                                        ...
                                                                        <div class="inline-block margin-right-20 ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox" id="222n"
                                                                                    name="" />
                                                                                <label for="222n">Motor Graders</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    <li class="list-group-item padding-0 ">
                                                                        ...
                                                                        <div class="inline-block margin-right-20 ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox" id="222e"
                                                                                    checked />
                                                                                <label for="222e">Motor Graders</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    <li class="list-group-item padding-0 ">
                                            ...
                                            <div class=" padding-left-20 padding-right-20">
                                                ...
                                                <div class="panel-group left-filters" id="AccordionFilters1">
                                                    ...
                                                    <!-- <div class="panel">
                                                        <div class="panel-heading" role="tab">
                                                            <a class="panel-title" data-toggle="collapse"
                                                                href="#Location1" data-parent="#AccordionFilters">
                                                                Warehouse
                                                            </a>
                                                        </div>
                                                        <div class="panel-collapse collapse in" id="Location1"
                                                            role="tabpanel">
                                                            <div class="panel-body padding-0">
                                                                ...
                                                                <ul class="list-group list-group-bordered mrq-cb"
                                                                        ...
                                                                        <div class="inline-block ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox"
                                                                                    id="Motor Graders"
                                                                                    value="Motor Graders">
                                                                                <label for="Motor Graders">Motor Graders
                                                                                </label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    <li class="list-group-item">
                                                                        ...
                                                                        <div class="inline-block ">
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox"
                                                                                    id="Backhoe Loaders"
                                                                                    value="Backhoe Loaders">
                                                                                <label for="Backhoe Loaders">Backhoe
                                                                                    Loaders</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    ...
                                                                    <li class="list-group-item">
                                                                        ...
                                                                        <div class="inline-block ">
                                                                            <div
                                                                                class="checkbox-custom checkbox-info margin-0 ">
                                                                                <input type="checkbox" id="Bulldozers"
                                                                                    value="Bulldozers">
                                                                                <label
                                                                                    for="Bulldozers">Bulldozers</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    ...
                                                                    <li class="list-group-item">
                                                                        ...
                                                                        <div class="inline-block ">
                                                                            <div
                                                                                ...
                                                                                <label
                                                                                    for="Skid-Steer Loaders">Skid-Steer
                                                                                    Loaders</label>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                    ...
                                                    <table
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a href="assets-industry-construction-bulldozer.php"
                                                                                class="font-weight-600">GSD238
                                                                            </a>
                                                                            <br />
                                                                            <i class="small">Motor Graders</i>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <td class="text-left hidden">Motor Graders</td>
                                                                <td class="text-center">
                                                                    <button type="button"
                                                            ...
                                                            <tr>
                                                                <td class="text-left">
                                                                    <div class="media" style="max-width: 150px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            ...
                                                                            <br />
                                                                            <i class="small">Backhoe Loaders</i>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td class="text-left">
                                                                ...
                                                                <td class="text-left hidden">Backhoe Loaders</td>
                                                                <td class="text-center">
                                                                    <button type="button"
                                                                        class="btn btn-icon  btn-default btn-xs collapsed"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-left hidden">Bulldozers</td>
                                                                <td class="text-center">
                                                                    <button type="button"
                                                                        class="btn btn-icon  btn-default btn-xs collapsed"
                                                            ...
                                                            <tr>
                                                                <td class="text-left">
                                                                    <div class="media" style="max-width: 200px;">
                                                                        ...
                                                                        <div class="media-body">
                                                                            ...
                                                                            <br />
                                                                            <i class="small">Skid-Steer Loaders</i>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <td class="text-left hidden">Skid-Steer Loaders</td>
                                                                <td class="text-center">
                                                                    <button type="button"
                                                                        class="btn btn-icon  btn-default btn-xs collapsed"
